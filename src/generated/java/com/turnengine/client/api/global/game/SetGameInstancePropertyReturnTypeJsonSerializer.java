...
public class SetGameInstancePropertyReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetGameInstancePropertyReturnTypeJsonSerializer() {
		this("SetGameInstancePropertyReturnType");
	}

	public SetGameInstancePropertyReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
