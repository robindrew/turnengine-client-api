...
public class RenameUserReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public RenameUserReturnTypeXmlSerializer() {
		this("RenameUserReturnType");
	}

	public RenameUserReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
