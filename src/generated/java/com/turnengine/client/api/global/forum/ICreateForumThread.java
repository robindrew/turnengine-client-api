...
public interface ICreateForumThread extends IExecutableBean<IForumThread>, IGlobalLoggedInBean<IForumThread>, Comparable<ICreateForumThread> {

	int SERIALIZATION_ID = 1402;
