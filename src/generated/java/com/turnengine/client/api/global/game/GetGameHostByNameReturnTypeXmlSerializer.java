...
public class GetGameHostByNameReturnTypeXmlSerializer implements IXmlSerializer<IGameHost> {

	private String name;

	public GetGameHostByNameReturnTypeXmlSerializer() {
		this("GetGameHostByNameReturnType");
	}

	public GetGameHostByNameReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
