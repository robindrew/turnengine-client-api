...
public class SetForumFlagReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetForumFlagReturnTypeXmlSerializer() {
		this("SetForumFlagReturnType");
	}

	public SetForumFlagReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
