...
public class RenameUserReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public RenameUserReturnTypeJsonSerializer() {
		this("RenameUserReturnType");
	}

	public RenameUserReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
