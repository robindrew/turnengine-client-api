...
public class GetGameByIdReturnTypeXmlSerializer implements IXmlSerializer<IGame> {

	private String name;

	public GetGameByIdReturnTypeXmlSerializer() {
		this("GetGameByIdReturnType");
	}

	public GetGameByIdReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
