...
public class NewGameInstanceReturnTypeXmlSerializer implements IXmlSerializer<IGameInstance> {

	private String name;

	public NewGameInstanceReturnTypeXmlSerializer() {
		this("NewGameInstanceReturnType");
	}

	public NewGameInstanceReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
