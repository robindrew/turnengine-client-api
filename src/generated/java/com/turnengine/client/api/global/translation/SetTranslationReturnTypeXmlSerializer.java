...
public class SetTranslationReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public SetTranslationReturnTypeXmlSerializer() {
		this("SetTranslationReturnType");
	}

	public SetTranslationReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
