...
public class ChangeUserPasswordReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public ChangeUserPasswordReturnTypeXmlSerializer() {
		this("ChangeUserPasswordReturnType");
	}

	public ChangeUserPasswordReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
