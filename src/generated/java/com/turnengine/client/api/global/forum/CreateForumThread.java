...
public class CreateForumThread implements ICreateForumThread {
	 ...
	 */
	public CreateForumThread(long loginId, int forumId, String subject, String content) {
		setLoginId(loginId);
		setForumId(forumId);
		setSubject(subject);
		setContent(content);
	 ...
	 */
	public CreateForumThread(ICreateForumThread clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ICreateForumThread that = (ICreateForumThread) object;
	...
	@Override
	public int compareTo(ICreateForumThread that) {
