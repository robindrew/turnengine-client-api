...
public class LogoutUserReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public LogoutUserReturnTypeXmlSerializer() {
		this("LogoutUserReturnType");
	}

	public LogoutUserReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
