...
public class SignupUserReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public SignupUserReturnTypeJsonSerializer() {
		this("SignupUserReturnType");
	}

	public SignupUserReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
