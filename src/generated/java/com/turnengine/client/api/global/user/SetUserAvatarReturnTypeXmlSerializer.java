...
public class SetUserAvatarReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetUserAvatarReturnTypeXmlSerializer() {
		this("SetUserAvatarReturnType");
	}

	public SetUserAvatarReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
