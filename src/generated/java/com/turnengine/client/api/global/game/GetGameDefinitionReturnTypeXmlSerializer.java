...
public class GetGameDefinitionReturnTypeXmlSerializer implements IXmlSerializer<IGameDefinition> {

	private String name;

	public GetGameDefinitionReturnTypeXmlSerializer() {
		this("GetGameDefinitionReturnType");
	}

	public GetGameDefinitionReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
