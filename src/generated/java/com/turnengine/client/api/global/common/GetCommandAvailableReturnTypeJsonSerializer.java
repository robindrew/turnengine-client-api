...
public class GetCommandAvailableReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public GetCommandAvailableReturnTypeJsonSerializer() {
		this("GetCommandAvailableReturnType");
	}

	public GetCommandAvailableReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
