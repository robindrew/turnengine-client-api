...
public class AdminVerifyUserReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public AdminVerifyUserReturnTypeJsonSerializer() {
		this("AdminVerifyUserReturnType");
	}

	public AdminVerifyUserReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
