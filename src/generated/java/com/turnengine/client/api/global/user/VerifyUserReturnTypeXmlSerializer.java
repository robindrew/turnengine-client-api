...
public class VerifyUserReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public VerifyUserReturnTypeXmlSerializer() {
		this("VerifyUserReturnType");
	}

	public VerifyUserReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
