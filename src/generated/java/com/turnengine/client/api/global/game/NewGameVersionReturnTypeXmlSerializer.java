...
public class NewGameVersionReturnTypeXmlSerializer implements IXmlSerializer<IGameVersion> {

	private String name;

	public NewGameVersionReturnTypeXmlSerializer() {
		this("NewGameVersionReturnType");
	}

	public NewGameVersionReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
