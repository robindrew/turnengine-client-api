...
public class AdminSetUserPasswordReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public AdminSetUserPasswordReturnTypeXmlSerializer() {
		this("AdminSetUserPasswordReturnType");
	}

	public AdminSetUserPasswordReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
