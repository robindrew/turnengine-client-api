...
public class GetGameByNameReturnTypeJsonSerializer implements IJsonSerializer<IGame> {

	private String name;

	public GetGameByNameReturnTypeJsonSerializer() {
		this("GetGameByNameReturnType");
	}

	public GetGameByNameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
