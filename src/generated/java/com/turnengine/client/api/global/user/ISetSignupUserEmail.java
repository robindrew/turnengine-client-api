...
public interface ISetSignupUserEmail extends IExecutableBean<Boolean>, IGlobalLoggedInBean<Boolean>, ISetupBean<Boolean>, Comparable<ISetSignupUserEmail> {

	int SERIALIZATION_ID = 1732;
