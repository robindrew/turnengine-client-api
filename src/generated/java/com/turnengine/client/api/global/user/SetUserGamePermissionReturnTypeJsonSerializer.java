...
public class SetUserGamePermissionReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetUserGamePermissionReturnTypeJsonSerializer() {
		this("SetUserGamePermissionReturnType");
	}

	public SetUserGamePermissionReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
