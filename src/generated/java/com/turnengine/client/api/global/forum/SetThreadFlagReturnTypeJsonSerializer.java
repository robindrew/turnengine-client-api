...
public class SetThreadFlagReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetThreadFlagReturnTypeJsonSerializer() {
		this("SetThreadFlagReturnType");
	}

	public SetThreadFlagReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
