...
public class CreateForumPostReturnTypeXmlSerializer implements IXmlSerializer<IForumPost> {

	private String name;

	public CreateForumPostReturnTypeXmlSerializer() {
		this("CreateForumPostReturnType");
	}

	public CreateForumPostReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
