...
public class SetUserAddressReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetUserAddressReturnTypeJsonSerializer() {
		this("SetUserAddressReturnType");
	}

	public SetUserAddressReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
