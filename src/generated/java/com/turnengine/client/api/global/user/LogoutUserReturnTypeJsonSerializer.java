...
public class LogoutUserReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public LogoutUserReturnTypeJsonSerializer() {
		this("LogoutUserReturnType");
	}

	public LogoutUserReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
