...
public class SetUserLanguageReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetUserLanguageReturnTypeJsonSerializer() {
		this("SetUserLanguageReturnType");
	}

	public SetUserLanguageReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
