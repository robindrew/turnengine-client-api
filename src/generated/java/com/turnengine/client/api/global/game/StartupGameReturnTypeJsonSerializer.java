...
public class StartupGameReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public StartupGameReturnTypeJsonSerializer() {
		this("StartupGameReturnType");
	}

	public StartupGameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
