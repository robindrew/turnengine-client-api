...
public class ChangeUserPasswordReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ChangeUserPasswordReturnTypeJsonSerializer() {
		this("ChangeUserPasswordReturnType");
	}

	public ChangeUserPasswordReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
