...
public class SetPostFlagReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetPostFlagReturnTypeXmlSerializer() {
		this("SetPostFlagReturnType");
	}

	public SetPostFlagReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
