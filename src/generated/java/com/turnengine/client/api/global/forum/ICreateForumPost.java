...
public interface ICreateForumPost extends IExecutableBean<IForumPost>, IGlobalLoggedInBean<IForumPost>, Comparable<ICreateForumPost> {

	int SERIALIZATION_ID = 1403;
