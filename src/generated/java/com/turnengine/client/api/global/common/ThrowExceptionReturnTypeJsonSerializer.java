...
public class ThrowExceptionReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ThrowExceptionReturnTypeJsonSerializer() {
		this("ThrowExceptionReturnType");
	}

	public ThrowExceptionReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
