...
public class StopServiceReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public StopServiceReturnTypeJsonSerializer() {
		this("StopServiceReturnType");
	}

	public StopServiceReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
