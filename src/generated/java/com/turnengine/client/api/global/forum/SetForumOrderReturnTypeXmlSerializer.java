...
public class SetForumOrderReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetForumOrderReturnTypeXmlSerializer() {
		this("SetForumOrderReturnType");
	}

	public SetForumOrderReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
