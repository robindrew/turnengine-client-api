...
public class AdminVerifyUserReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public AdminVerifyUserReturnTypeXmlSerializer() {
		this("AdminVerifyUserReturnType");
	}

	public AdminVerifyUserReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
