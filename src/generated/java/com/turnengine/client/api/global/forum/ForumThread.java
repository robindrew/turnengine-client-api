...
public class ForumThread implements IForumThread {
	...
	/** The poster field. */
	private IForumUser poster = null;
	/** The sticky field. */
	...
	/** The postList field. */
	private List<IForumPost> postList = null;
	 ...
	 */
	public ForumThread(int id, int forumId, int date, int lastUpdated, String subject, IForumUser poster, boolean sticky, boolean locked, boolean archived, boolean deleted, List<IForumPost> postList) {
		setId(id);
		setForumId(forumId);
		setDate(date);
	 ...
	 */
	public ForumThread(IForumThread clone) {
		setId(clone.getId());
	 ...
	 */
	@Override
	public List<IForumPost> getPostList() {
		return postList;
	}
	 ...
	 */
	@Override
	public void setPoster(IForumUser poster) {
		this.poster = poster;
	}
	 ...
	 */
	@Override
	public void setPostList(List<IForumPost> postList) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IForumThread that = (IForumThread) object;
	...
	@Override
	public int compareTo(IForumThread that) {
