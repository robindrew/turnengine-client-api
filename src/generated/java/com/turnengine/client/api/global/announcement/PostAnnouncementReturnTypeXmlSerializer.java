...
public class PostAnnouncementReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public PostAnnouncementReturnTypeXmlSerializer() {
		this("PostAnnouncementReturnType");
	}

	public PostAnnouncementReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
