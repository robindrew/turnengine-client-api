...
public class SetUserAddressReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetUserAddressReturnTypeXmlSerializer() {
		this("SetUserAddressReturnType");
	}

	public SetUserAddressReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
