...
public class GetGameDefinitionByHostPort implements IGetGameDefinitionByHostPort {
	 ...
	 */
	public GetGameDefinitionByHostPort() {
	}

	/**
	 * The fields constructor.
	 */
	public GetGameDefinitionByHostPort(String name, int port) {
		setName(name);
		setPort(port);
	}
	 ...
	 */
	public GetGameDefinitionByHostPort(IGetGameDefinitionByHostPort clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetGameDefinitionByHostPort that = (IGetGameDefinitionByHostPort) object;
	...
	@Override
	public int compareTo(IGetGameDefinitionByHostPort that) {
