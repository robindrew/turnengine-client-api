...
public class StartService implements IStartService {
	 ...
	 */
	public StartService(String project, int release, String service) {
		setProject(project);
		setRelease(release);
		setService(service);
	}
	 ...
	 */
	public StartService(IStartService clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IStartService that = (IStartService) object;
	...
	@Override
	public int compareTo(IStartService that) {
