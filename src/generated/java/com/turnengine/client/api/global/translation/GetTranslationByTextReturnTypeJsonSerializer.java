...
public class GetTranslationByTextReturnTypeJsonSerializer implements IJsonSerializer<ITranslation> {

	private String name;

	public GetTranslationByTextReturnTypeJsonSerializer() {
		this("GetTranslationByTextReturnType");
	}

	public GetTranslationByTextReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
