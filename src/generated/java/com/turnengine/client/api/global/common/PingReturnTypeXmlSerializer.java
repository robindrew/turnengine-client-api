...
public class PingReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public PingReturnTypeXmlSerializer() {
		this("PingReturnType");
	}

	public PingReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
