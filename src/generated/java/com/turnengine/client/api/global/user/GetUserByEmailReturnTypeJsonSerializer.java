...
public class GetUserByEmailReturnTypeJsonSerializer implements IJsonSerializer<IUser> {

	private String name;

	public GetUserByEmailReturnTypeJsonSerializer() {
		this("GetUserByEmailReturnType");
	}

	public GetUserByEmailReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
