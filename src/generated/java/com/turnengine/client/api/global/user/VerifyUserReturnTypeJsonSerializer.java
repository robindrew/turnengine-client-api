...
public class VerifyUserReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public VerifyUserReturnTypeJsonSerializer() {
		this("VerifyUserReturnType");
	}

	public VerifyUserReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
