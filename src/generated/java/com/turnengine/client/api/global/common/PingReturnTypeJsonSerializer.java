...
public class PingReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public PingReturnTypeJsonSerializer() {
		this("PingReturnType");
	}

	public PingReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
