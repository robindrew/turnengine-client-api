...
public class GetGameHostByIdReturnTypeXmlSerializer implements IXmlSerializer<IGameHost> {

	private String name;

	public GetGameHostByIdReturnTypeXmlSerializer() {
		this("GetGameHostByIdReturnType");
	}

	public GetGameHostByIdReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
