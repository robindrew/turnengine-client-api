...
public class AdminSetUserPasswordReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public AdminSetUserPasswordReturnTypeJsonSerializer() {
		this("AdminSetUserPasswordReturnType");
	}

	public AdminSetUserPasswordReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
