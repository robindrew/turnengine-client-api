...
public class DeleteAnnouncementReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public DeleteAnnouncementReturnTypeXmlSerializer() {
		this("DeleteAnnouncementReturnType");
	}

	public DeleteAnnouncementReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
