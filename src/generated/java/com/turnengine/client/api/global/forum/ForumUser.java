...
public class ForumUser implements IForumUser {
	 ...
	 */
	public ForumUser(int id, String name, int reputation, List<UserPermissionType> permissionList) {
		setId(id);
		setName(name);
	 ...
	 */
	public ForumUser(IForumUser clone) {
		setId(clone.getId());
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IForumUser that = (IForumUser) object;
	...
	@Override
	public int compareTo(IForumUser that) {
