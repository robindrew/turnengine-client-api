...
public class SetSignupVerificationReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetSignupVerificationReturnTypeXmlSerializer() {
		this("SetSignupVerificationReturnType");
	}

	public SetSignupVerificationReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
