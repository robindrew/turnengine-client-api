...
public class UpdateUserAddressCodeReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public UpdateUserAddressCodeReturnTypeXmlSerializer() {
		this("UpdateUserAddressCodeReturnType");
	}

	public UpdateUserAddressCodeReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
