...
public class UpdateUserAddressCodeReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public UpdateUserAddressCodeReturnTypeJsonSerializer() {
		this("UpdateUserAddressCodeReturnType");
	}

	public UpdateUserAddressCodeReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
