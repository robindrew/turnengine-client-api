...
public class DeleteAnnouncementReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public DeleteAnnouncementReturnTypeJsonSerializer() {
		this("DeleteAnnouncementReturnType");
	}

	public DeleteAnnouncementReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
