...
public class SetSignupUserEmailReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetSignupUserEmailReturnTypeJsonSerializer() {
		this("SetSignupUserEmailReturnType");
	}

	public SetSignupUserEmailReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
