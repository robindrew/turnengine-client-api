...
public class GetGameDefinitionsReturnTypeJsonSerializer implements IJsonSerializer<List<IGameDefinition>> {

	private String name;

	public GetGameDefinitionsReturnTypeJsonSerializer() {
		this("GetGameDefinitionsReturnType");
	}

	public GetGameDefinitionsReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
