...
public class GetThreadList implements IGetThreadList {
	 ...
	 */
	public GetThreadList(long loginId, int forumId, int pageNumber, int pageSize) {
		setLoginId(loginId);
		setForumId(forumId);
	 ...
	 */
	public GetThreadList(IGetThreadList clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetThreadList that = (IGetThreadList) object;
	...
	@Override
	public int compareTo(IGetThreadList that) {
