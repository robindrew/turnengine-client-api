...
import com.turnengine.client.api.global.game.GetGameDefinitionByHostPortXmlSerializer;
...
import com.turnengine.client.api.local.game.AddUnitsAtGameXmlSerializer;
...
import com.turnengine.client.api.local.game.GetUnitsAtGameXmlSerializer;
...
import com.turnengine.client.api.local.location.GetUnitsAtLocationXmlSerializer;
...
import com.turnengine.client.api.local.mobile.GetUnitsAtMobileXmlSerializer;
...
import com.turnengine.client.api.local.player.GetUnitsAtPlayerByGroupIdXmlSerializer;
import com.turnengine.client.api.local.player.GetUnitsAtPlayerXmlSerializer;
...
public class GlobalXmlSerializerFactory implements IObjectFactory<IXmlSerializer<?>> {
	...
	public GlobalXmlSerializerFactory() {
		...
		objectMap.put(GetGameDefinitionByHostPort.SERIALIZATION_ID, GetGameDefinitionByHostPortXmlSerializer.class);
		...
		objectMap.put("GetGameDefinitionByHostPort", GetGameDefinitionByHostPortXmlSerializer.class);
		...
		objectMap.put(AddUnitsAtGame.SERIALIZATION_ID, AddUnitsAtGameXmlSerializer.class);
		objectMap.put(GetUnitsAtGame.SERIALIZATION_ID, GetUnitsAtGameXmlSerializer.class);
		...
		objectMap.put("AddUnitsAtGame", AddUnitsAtGameXmlSerializer.class);
		objectMap.put("GetUnitsAtGame", GetUnitsAtGameXmlSerializer.class);
		...
		objectMap.put(GetUnitsAtLocation.SERIALIZATION_ID, GetUnitsAtLocationXmlSerializer.class);
		...
		objectMap.put("GetUnitsAtLocation", GetUnitsAtLocationXmlSerializer.class);
		...
		objectMap.put(GetUnitsAtMobile.SERIALIZATION_ID, GetUnitsAtMobileXmlSerializer.class);
		...
		objectMap.put("GetUnitsAtMobile", GetUnitsAtMobileXmlSerializer.class);
