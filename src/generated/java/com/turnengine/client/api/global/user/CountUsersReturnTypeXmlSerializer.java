...
public class CountUsersReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public CountUsersReturnTypeXmlSerializer() {
		this("CountUsersReturnType");
	}

	public CountUsersReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
