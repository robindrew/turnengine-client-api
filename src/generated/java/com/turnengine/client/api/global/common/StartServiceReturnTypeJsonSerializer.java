...
public class StartServiceReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public StartServiceReturnTypeJsonSerializer() {
		this("StartServiceReturnType");
	}

	public StartServiceReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
