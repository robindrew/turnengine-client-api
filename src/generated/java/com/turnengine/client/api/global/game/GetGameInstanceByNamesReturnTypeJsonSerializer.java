...
public class GetGameInstanceByNamesReturnTypeJsonSerializer implements IJsonSerializer<IGameInstance> {

	private String name;

	public GetGameInstanceByNamesReturnTypeJsonSerializer() {
		this("GetGameInstanceByNamesReturnType");
	}

	public GetGameInstanceByNamesReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
