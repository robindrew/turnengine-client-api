...
public class EditPostReturnTypeJsonSerializer implements IJsonSerializer<IForumPost> {

	private String name;

	public EditPostReturnTypeJsonSerializer() {
		this("EditPostReturnType");
	}

	public EditPostReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
