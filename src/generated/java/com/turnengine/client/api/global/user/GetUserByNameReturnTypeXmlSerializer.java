...
public class GetUserByNameReturnTypeXmlSerializer implements IXmlSerializer<IUser> {

	private String name;

	public GetUserByNameReturnTypeXmlSerializer() {
		this("GetUserByNameReturnType");
	}

	public GetUserByNameReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
