...
public class GetAnnouncementCountReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetAnnouncementCountReturnTypeXmlSerializer() {
		this("GetAnnouncementCountReturnType");
	}

	public GetAnnouncementCountReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
