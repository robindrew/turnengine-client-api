...
public class SendEmailReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SendEmailReturnTypeJsonSerializer() {
		this("SendEmailReturnType");
	}

	public SendEmailReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
