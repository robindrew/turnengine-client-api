...
public class SetThreadFlagReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetThreadFlagReturnTypeXmlSerializer() {
		this("SetThreadFlagReturnType");
	}

	public SetThreadFlagReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
