...
public class GetGameInstancesReturnTypeJsonSerializer implements IJsonSerializer<List<IGameInstance>> {

	private String name;

	public GetGameInstancesReturnTypeJsonSerializer() {
		this("GetGameInstancesReturnType");
	}

	public GetGameInstancesReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
