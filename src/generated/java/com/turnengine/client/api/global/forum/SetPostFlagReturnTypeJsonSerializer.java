...
public class SetPostFlagReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetPostFlagReturnTypeJsonSerializer() {
		this("SetPostFlagReturnType");
	}

	public SetPostFlagReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
