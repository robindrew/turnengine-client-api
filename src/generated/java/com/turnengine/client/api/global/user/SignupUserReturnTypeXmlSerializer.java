...
public class SignupUserReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public SignupUserReturnTypeXmlSerializer() {
		this("SignupUserReturnType");
	}

	public SignupUserReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
