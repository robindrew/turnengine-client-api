...
public class StopServiceReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public StopServiceReturnTypeXmlSerializer() {
		this("StopServiceReturnType");
	}

	public StopServiceReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
