...
public class SetSignupUserEmail implements ISetSignupUserEmail {
	 ...
	 */
	public SetSignupUserEmail() {
	}

	/**
	 * The fields constructor.
	 */
	public SetSignupUserEmail(long loginId, int instanceId, String subject, String content) {
		setLoginId(loginId);
	 ...
	 */
	public SetSignupUserEmail(ISetSignupUserEmail clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ISetSignupUserEmail that = (ISetSignupUserEmail) object;
	...
	@Override
	public int compareTo(ISetSignupUserEmail that) {
