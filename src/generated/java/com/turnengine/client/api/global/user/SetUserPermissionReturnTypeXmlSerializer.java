...
public class SetUserPermissionReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetUserPermissionReturnTypeXmlSerializer() {
		this("SetUserPermissionReturnType");
	}

	public SetUserPermissionReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
