...
public class PostAnnouncementReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public PostAnnouncementReturnTypeJsonSerializer() {
		this("PostAnnouncementReturnType");
	}

	public PostAnnouncementReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
