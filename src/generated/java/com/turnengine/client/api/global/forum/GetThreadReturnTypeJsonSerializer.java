...
public class GetThreadReturnTypeJsonSerializer implements IJsonSerializer<IForumThread> {

	private String name;

	public GetThreadReturnTypeJsonSerializer() {
		this("GetThreadReturnType");
	}

	public GetThreadReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
