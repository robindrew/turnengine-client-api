...
public class SetResetPasswordEmailReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetResetPasswordEmailReturnTypeJsonSerializer() {
		this("SetResetPasswordEmailReturnType");
	}

	public SetResetPasswordEmailReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
