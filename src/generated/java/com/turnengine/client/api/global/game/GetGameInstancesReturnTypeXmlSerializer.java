...
public class GetGameInstancesReturnTypeXmlSerializer implements IXmlSerializer<List<IGameInstance>> {

	private String name;

	public GetGameInstancesReturnTypeXmlSerializer() {
		this("GetGameInstancesReturnType");
	}

	public GetGameInstancesReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
