...
public class NewTranslationReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public NewTranslationReturnTypeJsonSerializer() {
		this("NewTranslationReturnType");
	}

	public NewTranslationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
