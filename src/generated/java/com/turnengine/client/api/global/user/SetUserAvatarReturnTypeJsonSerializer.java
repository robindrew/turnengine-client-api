...
public class SetUserAvatarReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetUserAvatarReturnTypeJsonSerializer() {
		this("SetUserAvatarReturnType");
	}

	public SetUserAvatarReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
