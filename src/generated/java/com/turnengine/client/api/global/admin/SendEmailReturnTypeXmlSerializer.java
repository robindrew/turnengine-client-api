...
public class SendEmailReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SendEmailReturnTypeXmlSerializer() {
		this("SendEmailReturnType");
	}

	public SendEmailReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
