...
public class SendResetPasswordEmailReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SendResetPasswordEmailReturnTypeXmlSerializer() {
		this("SendResetPasswordEmailReturnType");
	}

	public SendResetPasswordEmailReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
