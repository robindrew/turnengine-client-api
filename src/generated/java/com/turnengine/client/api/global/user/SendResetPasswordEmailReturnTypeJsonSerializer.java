...
public class SendResetPasswordEmailReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SendResetPasswordEmailReturnTypeJsonSerializer() {
		this("SendResetPasswordEmailReturnType");
	}

	public SendResetPasswordEmailReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
