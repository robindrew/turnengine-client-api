...
public class ResetPasswordReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ResetPasswordReturnTypeJsonSerializer() {
		this("ResetPasswordReturnType");
	}

	public ResetPasswordReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
