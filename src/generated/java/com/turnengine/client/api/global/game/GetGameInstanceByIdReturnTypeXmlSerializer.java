...
public class GetGameInstanceByIdReturnTypeXmlSerializer implements IXmlSerializer<IGameInstance> {

	private String name;

	public GetGameInstanceByIdReturnTypeXmlSerializer() {
		this("GetGameInstanceByIdReturnType");
	}

	public GetGameInstanceByIdReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
