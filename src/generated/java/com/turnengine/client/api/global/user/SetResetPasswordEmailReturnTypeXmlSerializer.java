...
public class SetResetPasswordEmailReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetResetPasswordEmailReturnTypeXmlSerializer() {
		this("SetResetPasswordEmailReturnType");
	}

	public SetResetPasswordEmailReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
