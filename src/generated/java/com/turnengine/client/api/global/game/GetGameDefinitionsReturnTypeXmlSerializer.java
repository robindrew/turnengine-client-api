...
public class GetGameDefinitionsReturnTypeXmlSerializer implements IXmlSerializer<List<IGameDefinition>> {

	private String name;

	public GetGameDefinitionsReturnTypeXmlSerializer() {
		this("GetGameDefinitionsReturnType");
	}

	public GetGameDefinitionsReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
