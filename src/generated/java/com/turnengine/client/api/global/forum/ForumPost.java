...
public class ForumPost implements IForumPost {
	 ...
	 */
	public ForumPost(int id, int threadId, int forumId, int date, int lastEdited, IForumUser poster, String subject, String content, boolean deleted) {
		setId(id);
	 ...
	 */
	public ForumPost(IForumPost clone) {
		setId(clone.getId());
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IForumPost that = (IForumPost) object;
	...
	@Override
	public int compareTo(IForumPost that) {
