...
public class GetTranslationByTextReturnTypeXmlSerializer implements IXmlSerializer<ITranslation> {

	private String name;

	public GetTranslationByTextReturnTypeXmlSerializer() {
		this("GetTranslationByTextReturnType");
	}

	public GetTranslationByTextReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
