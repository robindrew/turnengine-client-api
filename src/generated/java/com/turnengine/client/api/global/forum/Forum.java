...
public class Forum implements IForum {
	...
	private int posts = 0;
	/** The forumList field. */
	private List<IForum> forumList = null;
	/** The threadList field. */
	private List<IForumThread> threadList = null;
	 ...
	 */
	public Forum(int id, String name, int order, boolean locked, boolean archived, boolean deleted, int threads, int posts, List<IForum> forumList, List<IForumThread> threadList) {
		setId(id);
		setName(name);
		setOrder(order);
		setLocked(locked);
	 ...
	 */
	@Override
	public List<IForum> getForumList() {
		return forumList;
	}
	 ...
	 */
	@Override
	public List<IForumThread> getThreadList() {
		return threadList;
	}
	 ...
	 */
	@Override
	public void setForumList(List<IForum> forumList) {
	 ...
	 */
	@Override
	public void setThreadList(List<IForumThread> threadList) {
	...
	@Override
	public int compareTo(IForum that) {
