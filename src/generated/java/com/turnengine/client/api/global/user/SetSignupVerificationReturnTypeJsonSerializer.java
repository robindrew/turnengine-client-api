...
public class SetSignupVerificationReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetSignupVerificationReturnTypeJsonSerializer() {
		this("SetSignupVerificationReturnType");
	}

	public SetSignupVerificationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
