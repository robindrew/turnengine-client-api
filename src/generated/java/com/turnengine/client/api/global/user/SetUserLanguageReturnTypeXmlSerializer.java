...
public class SetUserLanguageReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetUserLanguageReturnTypeXmlSerializer() {
		this("SetUserLanguageReturnType");
	}

	public SetUserLanguageReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
