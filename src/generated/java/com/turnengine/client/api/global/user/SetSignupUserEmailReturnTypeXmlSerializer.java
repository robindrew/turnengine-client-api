...
public class SetSignupUserEmailReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetSignupUserEmailReturnTypeXmlSerializer() {
		this("SetSignupUserEmailReturnType");
	}

	public SetSignupUserEmailReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
