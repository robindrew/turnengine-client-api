...
public class LoginUserReturnTypeXmlSerializer implements IXmlSerializer<Long> {

	private String name;

	public LoginUserReturnTypeXmlSerializer() {
		this("LoginUserReturnType");
	}

	public LoginUserReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
