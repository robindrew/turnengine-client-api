...
public class ThrowExceptionReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public ThrowExceptionReturnTypeXmlSerializer() {
		this("ThrowExceptionReturnType");
	}

	public ThrowExceptionReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
