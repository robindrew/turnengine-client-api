...
public class SetUserPermissionReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetUserPermissionReturnTypeJsonSerializer() {
		this("SetUserPermissionReturnType");
	}

	public SetUserPermissionReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
