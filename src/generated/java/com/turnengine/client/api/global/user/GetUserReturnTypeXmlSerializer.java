...
public class GetUserReturnTypeXmlSerializer implements IXmlSerializer<IUser> {

	private String name;

	public GetUserReturnTypeXmlSerializer() {
		this("GetUserReturnType");
	}

	public GetUserReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
