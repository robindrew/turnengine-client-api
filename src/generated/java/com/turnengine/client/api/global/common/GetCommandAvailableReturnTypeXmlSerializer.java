...
public class GetCommandAvailableReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public GetCommandAvailableReturnTypeXmlSerializer() {
		this("GetCommandAvailableReturnType");
	}

	public GetCommandAvailableReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
