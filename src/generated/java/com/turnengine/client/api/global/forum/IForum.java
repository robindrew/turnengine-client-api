...
public interface IForum extends IBean, Comparable<IForum> {

	int SERIALIZATION_ID = 1411;
	 ...
	 */
	void setForumList(List<IForum> forumList);

	/**
	 * Setter for the threadList field.
	 * @param threadList the threadList value to set.
	 */
	void setThreadList(List<IForumThread> threadList);
}
