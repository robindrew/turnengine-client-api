...
public class GetUserByIdReturnTypeXmlSerializer implements IXmlSerializer<IUser> {

	private String name;

	public GetUserByIdReturnTypeXmlSerializer() {
		this("GetUserByIdReturnType");
	}

	public GetUserByIdReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
