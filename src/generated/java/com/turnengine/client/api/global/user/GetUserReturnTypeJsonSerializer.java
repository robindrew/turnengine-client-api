...
public class GetUserReturnTypeJsonSerializer implements IJsonSerializer<IUser> {

	private String name;

	public GetUserReturnTypeJsonSerializer() {
		this("GetUserReturnType");
	}

	public GetUserReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
