...
public class PostNews implements IPostNews {
	 ...
	 */
	public PostNews(long loginId, int instanceId, String recipient, int locationId, int mobileId, String format, String subject, String content) {
		setLoginId(loginId);
	 ...
	 */
	public PostNews(IPostNews clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IPostNews that = (IPostNews) object;
	...
	@Override
	public int compareTo(IPostNews that) {
