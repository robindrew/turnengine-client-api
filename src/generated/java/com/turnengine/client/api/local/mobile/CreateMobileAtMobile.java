...
public class CreateMobileAtMobile implements ICreateMobileAtMobile {
	 ...
	 */
	public CreateMobileAtMobile() {
	}

	/**
	 * The fields constructor.
	 */
	public CreateMobileAtMobile(long loginId, int instanceId, int mobileId, String name) {
		setLoginId(loginId);
	 ...
	 */
	public CreateMobileAtMobile(ICreateMobileAtMobile clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ICreateMobileAtMobile that = (ICreateMobileAtMobile) object;
	...
	@Override
	public int compareTo(ICreateMobileAtMobile that) {
