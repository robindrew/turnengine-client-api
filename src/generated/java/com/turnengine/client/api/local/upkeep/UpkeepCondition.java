...
public class UpkeepCondition implements IUpkeepCondition {
	 ...
	 */
	public UpkeepCondition() {
	}

	/**
	 * The fields constructor.
	 */
	public UpkeepCondition(int id, CreationConditionType conditionType, int conditionId1, long conditionAmount1, int conditionId2, long conditionAmount2, int conditionId3, long conditionAmount3, boolean optional) {
		setId(id);
	 ...
	 */
	public UpkeepCondition(IUpkeepCondition clone) {
		setId(clone.getId());
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IUpkeepCondition that = (IUpkeepCondition) object;
	...
	@Override
	public int compareTo(IUpkeepCondition that) {
