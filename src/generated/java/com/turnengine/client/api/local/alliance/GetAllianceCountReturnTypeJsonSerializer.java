...
public class GetAllianceCountReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public GetAllianceCountReturnTypeJsonSerializer() {
		this("GetAllianceCountReturnType");
	}

	public GetAllianceCountReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
