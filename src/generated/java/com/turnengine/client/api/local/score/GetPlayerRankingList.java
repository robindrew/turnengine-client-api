...
public class GetPlayerRankingList implements IGetPlayerRankingList {
	 ...
	 */
	public GetPlayerRankingList() {
	}

	/**
	 * The fields constructor.
	 */
	public GetPlayerRankingList(long loginId, int instanceId, int groupId, int pageNumber, int pageSize) {
		setLoginId(loginId);
	 ...
	 */
	public GetPlayerRankingList(IGetPlayerRankingList clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetPlayerRankingList that = (IGetPlayerRankingList) object;
	...
	@Override
	public int compareTo(IGetPlayerRankingList that) {
