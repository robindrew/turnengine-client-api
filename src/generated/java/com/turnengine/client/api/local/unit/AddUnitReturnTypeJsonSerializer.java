...
public class AddUnitReturnTypeJsonSerializer implements IJsonSerializer<IUnit> {

	private String name;

	public AddUnitReturnTypeJsonSerializer() {
		this("AddUnitReturnType");
	}

	public AddUnitReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
