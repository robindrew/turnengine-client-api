...
public class RequestToJoinAlliance implements IRequestToJoinAlliance {
	 ...
	 */
	public RequestToJoinAlliance() {
	}

	/**
	 * The fields constructor.
	 */
	public RequestToJoinAlliance(long loginId, int instanceId, int allianceId) {
		setLoginId(loginId);
	 ...
	 */
	public RequestToJoinAlliance(IRequestToJoinAlliance clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IRequestToJoinAlliance that = (IRequestToJoinAlliance) object;
	...
	@Override
	public int compareTo(IRequestToJoinAlliance that) {
