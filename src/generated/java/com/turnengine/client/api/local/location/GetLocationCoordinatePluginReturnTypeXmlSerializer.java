...
public class GetLocationCoordinatePluginReturnTypeXmlSerializer implements IXmlSerializer<IPluginDetails> {

	private String name;

	public GetLocationCoordinatePluginReturnTypeXmlSerializer() {
		this("GetLocationCoordinatePluginReturnType");
	}

	public GetLocationCoordinatePluginReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
