...
public class Alliance implements IAlliance {
	 ...
	 */
	public Alliance(int id, String name, int leaderId, String leaderName, int factionId, boolean invited, int members, List<IPlayerInfo> memberList, List<IGroupScore> scoreList, String tag) {
		setId(id);
		setName(name);
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IAlliance that = (IAlliance) object;
		...
		builder.append(this.getInvited(), that.getInvited());
	...
	@Override
	public int compareTo(IAlliance that) {
