...
public class SetPlayerLimitReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public SetPlayerLimitReturnTypeJsonSerializer() {
		this("SetPlayerLimitReturnType");
	}

	public SetPlayerLimitReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
