...
public class TransferUnitsToMobileReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public TransferUnitsToMobileReturnTypeJsonSerializer() {
		this("TransferUnitsToMobileReturnType");
	}

	public TransferUnitsToMobileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
