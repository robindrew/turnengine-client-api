...
public class SetMobilePropertyReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetMobilePropertyReturnTypeXmlSerializer() {
		this("SetMobilePropertyReturnType");
	}

	public SetMobilePropertyReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
