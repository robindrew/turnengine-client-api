...
public class ClearActionsQueuedAtPlayerReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public ClearActionsQueuedAtPlayerReturnTypeXmlSerializer() {
		this("ClearActionsQueuedAtPlayerReturnType");
	}

	public ClearActionsQueuedAtPlayerReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
