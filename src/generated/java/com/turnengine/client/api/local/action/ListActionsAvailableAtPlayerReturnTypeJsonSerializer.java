...
public class ListActionsAvailableAtPlayerReturnTypeJsonSerializer implements IJsonSerializer<List<IActionAvailable>> {

	private String name;

	public ListActionsAvailableAtPlayerReturnTypeJsonSerializer() {
		this("ListActionsAvailableAtPlayerReturnType");
	}

	public ListActionsAvailableAtPlayerReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
