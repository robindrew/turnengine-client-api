...
public class CreateAllianceForumPostReturnTypeJsonSerializer implements IJsonSerializer<IAllianceForumPost> {

	private String name;

	public CreateAllianceForumPostReturnTypeJsonSerializer() {
		this("CreateAllianceForumPostReturnType");
	}

	public CreateAllianceForumPostReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
