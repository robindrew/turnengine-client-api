...
public class SetMobilePropertyReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetMobilePropertyReturnTypeJsonSerializer() {
		this("SetMobilePropertyReturnType");
	}

	public SetMobilePropertyReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
