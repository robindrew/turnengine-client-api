...
public class SetMobileMovementPluginReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetMobileMovementPluginReturnTypeJsonSerializer() {
		this("SetMobileMovementPluginReturnType");
	}

	public SetMobileMovementPluginReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
