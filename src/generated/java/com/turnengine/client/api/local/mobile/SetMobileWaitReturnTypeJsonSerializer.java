...
public class SetMobileWaitReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetMobileWaitReturnTypeJsonSerializer() {
		this("SetMobileWaitReturnType");
	}

	public SetMobileWaitReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
