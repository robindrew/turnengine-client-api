...
public class PostNewsReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public PostNewsReturnTypeJsonSerializer() {
		this("PostNewsReturnType");
	}

	public PostNewsReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
