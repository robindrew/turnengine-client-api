...
public class SetStorageItemReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetStorageItemReturnTypeJsonSerializer() {
		this("SetStorageItemReturnType");
	}

	public SetStorageItemReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
