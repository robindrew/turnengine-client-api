...
public class LeaveAllianceReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public LeaveAllianceReturnTypeJsonSerializer() {
		this("LeaveAllianceReturnType");
	}

	public LeaveAllianceReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
