...
public class EditAlliancePostReturnTypeXmlSerializer implements IXmlSerializer<IAllianceForumPost> {

	private String name;

	public EditAlliancePostReturnTypeXmlSerializer() {
		this("EditAlliancePostReturnType");
	}

	public EditAlliancePostReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
