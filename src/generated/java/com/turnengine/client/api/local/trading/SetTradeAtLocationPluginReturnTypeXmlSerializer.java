...
public class SetTradeAtLocationPluginReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetTradeAtLocationPluginReturnTypeXmlSerializer() {
		this("SetTradeAtLocationPluginReturnType");
	}

	public SetTradeAtLocationPluginReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
