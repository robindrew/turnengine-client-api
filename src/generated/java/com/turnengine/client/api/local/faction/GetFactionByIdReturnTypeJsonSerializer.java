...
public class GetFactionByIdReturnTypeJsonSerializer implements IJsonSerializer<IFaction> {

	private String name;

	public GetFactionByIdReturnTypeJsonSerializer() {
		this("GetFactionByIdReturnType");
	}

	public GetFactionByIdReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
