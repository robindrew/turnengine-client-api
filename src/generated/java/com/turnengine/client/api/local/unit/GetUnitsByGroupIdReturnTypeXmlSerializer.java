...
public class GetUnitsByGroupIdReturnTypeXmlSerializer implements IXmlSerializer<List<IUnit>> {

	private String name;

	public GetUnitsByGroupIdReturnTypeXmlSerializer() {
		this("GetUnitsByGroupIdReturnType");
	}

	public GetUnitsByGroupIdReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
