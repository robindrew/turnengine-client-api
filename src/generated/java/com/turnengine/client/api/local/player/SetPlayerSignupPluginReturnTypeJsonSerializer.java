...
public class SetPlayerSignupPluginReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetPlayerSignupPluginReturnTypeJsonSerializer() {
		this("SetPlayerSignupPluginReturnType");
	}

	public SetPlayerSignupPluginReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
