...
public interface IEditAlliancePost extends IExecutableBean<IAllianceForumPost>, ILocalLoggedInBean<IAllianceForumPost>, Comparable<IEditAlliancePost> {

	int SERIALIZATION_ID = 2208;
