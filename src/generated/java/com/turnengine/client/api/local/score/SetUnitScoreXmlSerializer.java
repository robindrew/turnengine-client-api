...
public class SetUnitScoreXmlSerializer implements IXmlSerializer<ISetUnitScore> {

	private String name;

	public SetUnitScoreXmlSerializer() {
		this("SetUnitScore");
	}

	public SetUnitScoreXmlSerializer(String name) {
		this.name = name;
	}
	...
	@Override
	public ISetUnitScore readObject(IXmlReader reader) {
	...
	@Override
	public void writeObject(IXmlWriter writer, ISetUnitScore object) {
