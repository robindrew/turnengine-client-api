...
public class SetAlliancesEnabledReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetAlliancesEnabledReturnTypeXmlSerializer() {
		this("SetAlliancesEnabledReturnType");
	}

	public SetAlliancesEnabledReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
