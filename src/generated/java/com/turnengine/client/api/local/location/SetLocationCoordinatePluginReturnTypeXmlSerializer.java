...
public class SetLocationCoordinatePluginReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetLocationCoordinatePluginReturnTypeXmlSerializer() {
		this("SetLocationCoordinatePluginReturnType");
	}

	public SetLocationCoordinatePluginReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
