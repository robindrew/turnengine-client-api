...
public class SetSetupBeanListFileReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetSetupBeanListFileReturnTypeXmlSerializer() {
		this("SetSetupBeanListFileReturnType");
	}

	public SetSetupBeanListFileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
