...
public class WaitMobileReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public WaitMobileReturnTypeXmlSerializer() {
		this("WaitMobileReturnType");
	}

	public WaitMobileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
