...
public class SetPlayerAvatarReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetPlayerAvatarReturnTypeXmlSerializer() {
		this("SetPlayerAvatarReturnType");
	}

	public SetPlayerAvatarReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
