...
public class GetPlayerScoresReturnTypeXmlSerializer implements IXmlSerializer<List<ITurnScore>> {

	private String name;

	public GetPlayerScoresReturnTypeXmlSerializer() {
		this("GetPlayerScoresReturnType");
	}

	public GetPlayerScoresReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
