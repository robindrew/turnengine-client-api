...
public class SignupPlayerReturnTypeJsonSerializer implements IJsonSerializer<IPlayer> {

	private String name;

	public SignupPlayerReturnTypeJsonSerializer() {
		this("SignupPlayerReturnType");
	}

	public SignupPlayerReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
