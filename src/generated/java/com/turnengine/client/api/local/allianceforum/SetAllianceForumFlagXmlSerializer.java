...
public class SetAllianceForumFlagXmlSerializer implements IXmlSerializer<ISetAllianceForumFlag> {

	private String name;

	public SetAllianceForumFlagXmlSerializer() {
		this("SetAllianceForumFlag");
	}

	public SetAllianceForumFlagXmlSerializer(String name) {
		this.name = name;
	}
	...
	@Override
	public ISetAllianceForumFlag readObject(IXmlReader reader) {
	...
	@Override
	public void writeObject(IXmlWriter writer, ISetAllianceForumFlag object) {
