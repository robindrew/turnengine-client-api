...
public class CreateMobileAtMobileReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public CreateMobileAtMobileReturnTypeJsonSerializer() {
		this("CreateMobileAtMobileReturnType");
	}

	public CreateMobileAtMobileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
