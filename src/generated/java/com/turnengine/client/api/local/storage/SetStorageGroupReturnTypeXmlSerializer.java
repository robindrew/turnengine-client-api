...
public class SetStorageGroupReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetStorageGroupReturnTypeXmlSerializer() {
		this("SetStorageGroupReturnType");
	}

	public SetStorageGroupReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
