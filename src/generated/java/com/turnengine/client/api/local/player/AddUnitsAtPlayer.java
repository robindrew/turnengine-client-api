...
public class AddUnitsAtPlayer implements IAddUnitsAtPlayer {
	 ...
	 */
	public AddUnitsAtPlayer() {
	}

	/**
	 * The fields constructor.
	 */
	public AddUnitsAtPlayer(long loginId, int instanceId, int unitId, long amount) {
		setLoginId(loginId);
	 ...
	 */
	public AddUnitsAtPlayer(IAddUnitsAtPlayer clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IAddUnitsAtPlayer that = (IAddUnitsAtPlayer) object;
	...
	@Override
	public int compareTo(IAddUnitsAtPlayer that) {
