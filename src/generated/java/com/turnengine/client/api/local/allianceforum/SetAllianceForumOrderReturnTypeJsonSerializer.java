...
public class SetAllianceForumOrderReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetAllianceForumOrderReturnTypeJsonSerializer() {
		this("SetAllianceForumOrderReturnType");
	}

	public SetAllianceForumOrderReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
