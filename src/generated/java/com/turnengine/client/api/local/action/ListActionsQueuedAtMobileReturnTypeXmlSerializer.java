...
public class ListActionsQueuedAtMobileReturnTypeXmlSerializer implements IXmlSerializer<List<IActionQueued>> {

	private String name;

	public ListActionsQueuedAtMobileReturnTypeXmlSerializer() {
		this("ListActionsQueuedAtMobileReturnType");
	}

	public ListActionsQueuedAtMobileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
