...
public class SetAlliancePostFlagReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetAlliancePostFlagReturnTypeJsonSerializer() {
		this("SetAlliancePostFlagReturnType");
	}

	public SetAlliancePostFlagReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
