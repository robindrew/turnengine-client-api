...
public class AddParentGroupReturnTypeJsonSerializer implements IJsonSerializer<IGroup> {

	private String name;

	public AddParentGroupReturnTypeJsonSerializer() {
		this("AddParentGroupReturnType");
	}

	public AddParentGroupReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
