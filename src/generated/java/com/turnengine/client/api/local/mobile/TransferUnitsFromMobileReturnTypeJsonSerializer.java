...
public class TransferUnitsFromMobileReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public TransferUnitsFromMobileReturnTypeJsonSerializer() {
		this("TransferUnitsFromMobileReturnType");
	}

	public TransferUnitsFromMobileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
