...
public class TransferUnitsBetweenMobilesReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public TransferUnitsBetweenMobilesReturnTypeJsonSerializer() {
		this("TransferUnitsBetweenMobilesReturnType");
	}

	public TransferUnitsBetweenMobilesReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
