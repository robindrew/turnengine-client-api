...
public class GetUnitsAtMobileReturnTypeXmlSerializer implements IXmlSerializer<List<IUnitCount>> {

	private String name;

	public GetUnitsAtMobileReturnTypeXmlSerializer() {
		this("GetUnitsAtMobileReturnType");
	}

	public GetUnitsAtMobileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
