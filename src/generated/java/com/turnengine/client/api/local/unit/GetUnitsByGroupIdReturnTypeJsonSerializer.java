...
public class GetUnitsByGroupIdReturnTypeJsonSerializer implements IJsonSerializer<List<IUnit>> {

	private String name;

	public GetUnitsByGroupIdReturnTypeJsonSerializer() {
		this("GetUnitsByGroupIdReturnType");
	}

	public GetUnitsByGroupIdReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
