...
public class DestroyEmptyMobileReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public DestroyEmptyMobileReturnTypeJsonSerializer() {
		this("DestroyEmptyMobileReturnType");
	}

	public DestroyEmptyMobileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
