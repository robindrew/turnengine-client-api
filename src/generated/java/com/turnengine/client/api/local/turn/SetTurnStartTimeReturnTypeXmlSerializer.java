...
public class SetTurnStartTimeReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetTurnStartTimeReturnTypeXmlSerializer() {
		this("SetTurnStartTimeReturnType");
	}

	public SetTurnStartTimeReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
