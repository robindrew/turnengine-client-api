...
public class RenamePlayerReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public RenamePlayerReturnTypeJsonSerializer() {
		this("RenamePlayerReturnType");
	}

	public RenamePlayerReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
