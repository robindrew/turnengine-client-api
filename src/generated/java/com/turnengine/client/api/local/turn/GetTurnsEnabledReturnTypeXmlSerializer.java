...
public class GetTurnsEnabledReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public GetTurnsEnabledReturnTypeXmlSerializer() {
		this("GetTurnsEnabledReturnType");
	}

	public GetTurnsEnabledReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
