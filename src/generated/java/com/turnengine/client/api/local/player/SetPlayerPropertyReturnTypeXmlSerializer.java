...
public class SetPlayerPropertyReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetPlayerPropertyReturnTypeXmlSerializer() {
		this("SetPlayerPropertyReturnType");
	}

	public SetPlayerPropertyReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
