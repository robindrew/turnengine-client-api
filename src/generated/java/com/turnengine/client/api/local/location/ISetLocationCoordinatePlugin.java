...
public interface ISetLocationCoordinatePlugin extends IExecutableBean<Boolean>, ILocalLoggedInBean<Boolean>, ISetupBean<Boolean>, Comparable<ISetLocationCoordinatePlugin> {

	int SERIALIZATION_ID = 5705;
