...
public class GetAllianceMemberCountReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public GetAllianceMemberCountReturnTypeJsonSerializer() {
		this("GetAllianceMemberCountReturnType");
	}

	public GetAllianceMemberCountReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
