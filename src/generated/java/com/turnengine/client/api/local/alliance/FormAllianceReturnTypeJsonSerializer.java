...
public class FormAllianceReturnTypeJsonSerializer implements IJsonSerializer<IAlliance> {

	private String name;

	public FormAllianceReturnTypeJsonSerializer() {
		this("FormAllianceReturnType");
	}

	public FormAllianceReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
