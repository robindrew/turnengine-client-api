...
public class CancelActionAtPlayerReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public CancelActionAtPlayerReturnTypeXmlSerializer() {
		this("CancelActionAtPlayerReturnType");
	}

	public CancelActionAtPlayerReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
