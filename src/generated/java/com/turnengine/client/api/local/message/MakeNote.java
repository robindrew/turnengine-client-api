...
public class MakeNote implements IMakeNote {
	 ...
	 */
	public MakeNote(long loginId, int instanceId, String subject, String content) {
		setLoginId(loginId);
	 ...
	 */
	public MakeNote(IMakeNote clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IMakeNote that = (IMakeNote) object;
	...
	@Override
	public int compareTo(IMakeNote that) {
