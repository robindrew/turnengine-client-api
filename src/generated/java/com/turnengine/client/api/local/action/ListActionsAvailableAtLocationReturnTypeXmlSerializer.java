...
public class ListActionsAvailableAtLocationReturnTypeXmlSerializer implements IXmlSerializer<List<IActionAvailable>> {

	private String name;

	public ListActionsAvailableAtLocationReturnTypeXmlSerializer() {
		this("ListActionsAvailableAtLocationReturnType");
	}

	public ListActionsAvailableAtLocationReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
