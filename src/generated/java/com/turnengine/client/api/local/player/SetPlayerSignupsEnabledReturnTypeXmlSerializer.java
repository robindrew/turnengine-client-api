...
public class SetPlayerSignupsEnabledReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetPlayerSignupsEnabledReturnTypeXmlSerializer() {
		this("SetPlayerSignupsEnabledReturnType");
	}

	public SetPlayerSignupsEnabledReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
