...
public class ListActionsExecutingAtLocationReturnTypeJsonSerializer implements IJsonSerializer<List<IActionExecuting>> {

	private String name;

	public ListActionsExecutingAtLocationReturnTypeJsonSerializer() {
		this("ListActionsExecutingAtLocationReturnType");
	}

	public ListActionsExecutingAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
