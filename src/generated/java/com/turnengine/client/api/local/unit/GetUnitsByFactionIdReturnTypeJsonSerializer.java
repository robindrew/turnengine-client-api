...
public class GetUnitsByFactionIdReturnTypeJsonSerializer implements IJsonSerializer<List<IUnit>> {

	private String name;

	public GetUnitsByFactionIdReturnTypeJsonSerializer() {
		this("GetUnitsByFactionIdReturnType");
	}

	public GetUnitsByFactionIdReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
