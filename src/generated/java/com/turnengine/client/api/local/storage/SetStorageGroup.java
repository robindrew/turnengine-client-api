...
public class SetStorageGroup implements ISetStorageGroup {
	 ...
	 */
	public SetStorageGroup(long loginId, int instanceId, String parentName, String groupName, long capacity, StorageType type) {
		setLoginId(loginId);
	 ...
	 */
	public SetStorageGroup(ISetStorageGroup clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ISetStorageGroup that = (ISetStorageGroup) object;
	...
	@Override
	public int compareTo(ISetStorageGroup that) {
