...
public class ClearActionQueuedAtPlayerReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public ClearActionQueuedAtPlayerReturnTypeXmlSerializer() {
		this("ClearActionQueuedAtPlayerReturnType");
	}

	public ClearActionQueuedAtPlayerReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
