...
public class SetScoreUpdaterGroupReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetScoreUpdaterGroupReturnTypeXmlSerializer() {
		this("SetScoreUpdaterGroupReturnType");
	}

	public SetScoreUpdaterGroupReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
