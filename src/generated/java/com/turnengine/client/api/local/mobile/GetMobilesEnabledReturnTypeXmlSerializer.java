...
public class GetMobilesEnabledReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public GetMobilesEnabledReturnTypeXmlSerializer() {
		this("GetMobilesEnabledReturnType");
	}

	public GetMobilesEnabledReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
