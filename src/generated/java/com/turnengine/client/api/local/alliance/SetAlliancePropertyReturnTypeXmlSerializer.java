...
public class SetAlliancePropertyReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetAlliancePropertyReturnTypeXmlSerializer() {
		this("SetAlliancePropertyReturnType");
	}

	public SetAlliancePropertyReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
