...
public class SetAlliancePropertyReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetAlliancePropertyReturnTypeJsonSerializer() {
		this("SetAlliancePropertyReturnType");
	}

	public SetAlliancePropertyReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
