...
public class MoveMobileReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public MoveMobileReturnTypeJsonSerializer() {
		this("MoveMobileReturnType");
	}

	public MoveMobileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
