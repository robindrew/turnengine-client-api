...
public class SetMobileMoveReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetMobileMoveReturnTypeXmlSerializer() {
		this("SetMobileMoveReturnType");
	}

	public SetMobileMoveReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
