...
public class SetTurnIntervalReturnTypeJsonSerializer implements IJsonSerializer<Long> {

	private String name;

	public SetTurnIntervalReturnTypeJsonSerializer() {
		this("SetTurnIntervalReturnType");
	}

	public SetTurnIntervalReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
