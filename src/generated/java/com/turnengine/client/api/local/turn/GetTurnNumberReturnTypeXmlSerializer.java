...
public class GetTurnNumberReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetTurnNumberReturnTypeXmlSerializer() {
		this("GetTurnNumberReturnType");
	}

	public GetTurnNumberReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
