...
public class InviteToJoinAlliance implements IInviteToJoinAlliance {
	 ...
	 */
	public InviteToJoinAlliance() {
	}

	/**
	 * The fields constructor.
	 */
	public InviteToJoinAlliance(long loginId, int instanceId, int playerId) {
		setLoginId(loginId);
	 ...
	 */
	public InviteToJoinAlliance(IInviteToJoinAlliance clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IInviteToJoinAlliance that = (IInviteToJoinAlliance) object;
	...
	@Override
	public int compareTo(IInviteToJoinAlliance that) {
