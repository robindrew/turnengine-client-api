...
public class SetTurnIntervalTimeReturnTypeXmlSerializer implements IXmlSerializer<Long> {

	private String name;

	public SetTurnIntervalTimeReturnTypeXmlSerializer() {
		this("SetTurnIntervalTimeReturnType");
	}

	public SetTurnIntervalTimeReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
