...
public class GetAllianceCountReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetAllianceCountReturnTypeXmlSerializer() {
		this("GetAllianceCountReturnType");
	}

	public GetAllianceCountReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
