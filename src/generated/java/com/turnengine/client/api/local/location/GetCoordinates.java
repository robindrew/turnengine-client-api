...
public class GetCoordinates implements IGetCoordinates {
	 ...
	 */
	public GetCoordinates(long loginId, int instanceId, int locationId) {
		setLoginId(loginId);
	 ...
	 */
	public GetCoordinates(IGetCoordinates clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetCoordinates that = (IGetCoordinates) object;
	...
	@Override
	public int compareTo(IGetCoordinates that) {
