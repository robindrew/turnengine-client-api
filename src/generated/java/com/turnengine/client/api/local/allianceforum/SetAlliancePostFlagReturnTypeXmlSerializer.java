...
public class SetAlliancePostFlagReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetAlliancePostFlagReturnTypeXmlSerializer() {
		this("SetAlliancePostFlagReturnType");
	}

	public SetAlliancePostFlagReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
