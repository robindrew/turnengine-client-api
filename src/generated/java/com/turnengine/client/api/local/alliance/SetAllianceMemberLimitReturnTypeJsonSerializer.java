...
public class SetAllianceMemberLimitReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public SetAllianceMemberLimitReturnTypeJsonSerializer() {
		this("SetAllianceMemberLimitReturnType");
	}

	public SetAllianceMemberLimitReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
