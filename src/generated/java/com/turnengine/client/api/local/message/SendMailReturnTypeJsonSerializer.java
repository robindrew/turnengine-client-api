...
public class SendMailReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public SendMailReturnTypeJsonSerializer() {
		this("SendMailReturnType");
	}

	public SendMailReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
