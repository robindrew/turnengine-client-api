...
public class SetAllianceMemberLimitReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public SetAllianceMemberLimitReturnTypeXmlSerializer() {
		this("SetAllianceMemberLimitReturnType");
	}

	public SetAllianceMemberLimitReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
