...
public class GetMessageCountByFormatReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public GetMessageCountByFormatReturnTypeJsonSerializer() {
		this("GetMessageCountByFormatReturnType");
	}

	public GetMessageCountByFormatReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
