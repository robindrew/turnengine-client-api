...
public class RequestToJoinAllianceByNameReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public RequestToJoinAllianceByNameReturnTypeXmlSerializer() {
		this("RequestToJoinAllianceByNameReturnType");
	}

	public RequestToJoinAllianceByNameReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
