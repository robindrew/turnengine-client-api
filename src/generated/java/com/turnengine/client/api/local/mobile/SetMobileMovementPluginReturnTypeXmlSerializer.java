...
public class SetMobileMovementPluginReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetMobileMovementPluginReturnTypeXmlSerializer() {
		this("SetMobileMovementPluginReturnType");
	}

	public SetMobileMovementPluginReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
