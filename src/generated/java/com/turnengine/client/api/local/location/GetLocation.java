...
public class GetLocation implements IGetLocation {
	 ...
	 */
	public GetLocation(long loginId, int instanceId, int locationId) {
		setLoginId(loginId);
	 ...
	 */
	public GetLocation(IGetLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetLocation that = (IGetLocation) object;
	...
	@Override
	public int compareTo(IGetLocation that) {
