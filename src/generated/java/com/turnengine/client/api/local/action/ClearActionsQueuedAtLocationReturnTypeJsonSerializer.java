...
public class ClearActionsQueuedAtLocationReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ClearActionsQueuedAtLocationReturnTypeJsonSerializer() {
		this("ClearActionsQueuedAtLocationReturnType");
	}

	public ClearActionsQueuedAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
