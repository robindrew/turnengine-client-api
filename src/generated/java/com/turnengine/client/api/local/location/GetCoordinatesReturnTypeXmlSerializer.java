...
public class GetCoordinatesReturnTypeXmlSerializer implements IXmlSerializer<int[]> {

	private String name;

	public GetCoordinatesReturnTypeXmlSerializer() {
		this("GetCoordinatesReturnType");
	}

	public GetCoordinatesReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
