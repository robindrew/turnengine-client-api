...
public class DestroyEmptyMobileReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public DestroyEmptyMobileReturnTypeXmlSerializer() {
		this("DestroyEmptyMobileReturnType");
	}

	public DestroyEmptyMobileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
