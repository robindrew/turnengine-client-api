...
public class ClearActionQueuedAtLocation implements IClearActionQueuedAtLocation {
	 ...
	 */
	public ClearActionQueuedAtLocation() {
	}

	/**
	 * The fields constructor.
	 */
	public ClearActionQueuedAtLocation(long loginId, int instanceId, int locationId, int index) {
		setLoginId(loginId);
	 ...
	 */
	public ClearActionQueuedAtLocation(IClearActionQueuedAtLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IClearActionQueuedAtLocation that = (IClearActionQueuedAtLocation) object;
	...
	@Override
	public int compareTo(IClearActionQueuedAtLocation that) {
