...
public class GetLocalTrace implements IGetLocalTrace {
	 ...
	 */
	public GetLocalTrace(long loginId, int instanceId, String id) {
		setLoginId(loginId);
	 ...
	 */
	public GetLocalTrace(IGetLocalTrace clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetLocalTrace that = (IGetLocalTrace) object;
	...
	@Override
	public int compareTo(IGetLocalTrace that) {
