...
public class GetMessageCountByFormatReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetMessageCountByFormatReturnTypeXmlSerializer() {
		this("GetMessageCountByFormatReturnType");
	}

	public GetMessageCountByFormatReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
