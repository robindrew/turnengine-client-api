...
public class SetStorageItemReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetStorageItemReturnTypeXmlSerializer() {
		this("SetStorageItemReturnType");
	}

	public SetStorageItemReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
