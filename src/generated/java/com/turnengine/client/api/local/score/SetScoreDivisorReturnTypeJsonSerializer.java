...
public class SetScoreDivisorReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetScoreDivisorReturnTypeJsonSerializer() {
		this("SetScoreDivisorReturnType");
	}

	public SetScoreDivisorReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
