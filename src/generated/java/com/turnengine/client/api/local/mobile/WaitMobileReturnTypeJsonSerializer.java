...
public class WaitMobileReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public WaitMobileReturnTypeJsonSerializer() {
		this("WaitMobileReturnType");
	}

	public WaitMobileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
