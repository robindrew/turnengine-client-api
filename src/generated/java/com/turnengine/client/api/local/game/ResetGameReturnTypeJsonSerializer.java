...
public class ResetGameReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ResetGameReturnTypeJsonSerializer() {
		this("ResetGameReturnType");
	}

	public ResetGameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
