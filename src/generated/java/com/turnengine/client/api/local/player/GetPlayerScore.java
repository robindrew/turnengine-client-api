...
public class GetPlayerScore implements IGetPlayerScore {
	 ...
	 */
	public GetPlayerScore(long loginId, int instanceId, int groupId) {
		setLoginId(loginId);
	 ...
	 */
	public GetPlayerScore(IGetPlayerScore clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetPlayerScore that = (IGetPlayerScore) object;
	...
	@Override
	public int compareTo(IGetPlayerScore that) {
