...
public class LeaveAllianceReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public LeaveAllianceReturnTypeXmlSerializer() {
		this("LeaveAllianceReturnType");
	}

	public LeaveAllianceReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
