...
public class StartActionAtLocationReturnTypeXmlSerializer implements IXmlSerializer<IActionStatus> {

	private String name;

	public StartActionAtLocationReturnTypeXmlSerializer() {
		this("StartActionAtLocationReturnType");
	}

	public StartActionAtLocationReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
