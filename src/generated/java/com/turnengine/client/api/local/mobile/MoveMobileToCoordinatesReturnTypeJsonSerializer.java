...
public class MoveMobileToCoordinatesReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public MoveMobileToCoordinatesReturnTypeJsonSerializer() {
		this("MoveMobileToCoordinatesReturnType");
	}

	public MoveMobileToCoordinatesReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
