...
public class ListActionsAvailableAtLocationReturnTypeJsonSerializer implements IJsonSerializer<List<IActionAvailable>> {

	private String name;

	public ListActionsAvailableAtLocationReturnTypeJsonSerializer() {
		this("ListActionsAvailableAtLocationReturnType");
	}

	public ListActionsAvailableAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
