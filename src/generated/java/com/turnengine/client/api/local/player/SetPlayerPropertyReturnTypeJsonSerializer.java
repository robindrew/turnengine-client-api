...
public class SetPlayerPropertyReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetPlayerPropertyReturnTypeJsonSerializer() {
		this("SetPlayerPropertyReturnType");
	}

	public SetPlayerPropertyReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
