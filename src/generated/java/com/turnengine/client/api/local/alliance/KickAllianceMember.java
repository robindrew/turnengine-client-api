...
public class KickAllianceMember implements IKickAllianceMember {
	 ...
	 */
	public KickAllianceMember() {
	}

	/**
	 * The fields constructor.
	 */
	public KickAllianceMember(long loginId, int instanceId, int playerId) {
		setLoginId(loginId);
	 ...
	 */
	public KickAllianceMember(IKickAllianceMember clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IKickAllianceMember that = (IKickAllianceMember) object;
	...
	@Override
	public int compareTo(IKickAllianceMember that) {
