...
public class GetScoreDivisorReturnTypeJsonSerializer implements IJsonSerializer<Long> {

	private String name;

	public GetScoreDivisorReturnTypeJsonSerializer() {
		this("GetScoreDivisorReturnType");
	}

	public GetScoreDivisorReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
