...
public class SetLocationGenerationPluginReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetLocationGenerationPluginReturnTypeJsonSerializer() {
		this("SetLocationGenerationPluginReturnType");
	}

	public SetLocationGenerationPluginReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
