...
public class ClearActionsQueuedAtPlayerReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ClearActionsQueuedAtPlayerReturnTypeJsonSerializer() {
		this("ClearActionsQueuedAtPlayerReturnType");
	}

	public ClearActionsQueuedAtPlayerReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
