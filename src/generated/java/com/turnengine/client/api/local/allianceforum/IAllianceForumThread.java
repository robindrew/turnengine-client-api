...
public interface IAllianceForumThread extends IBean, Comparable<IAllianceForumThread> {

	int SERIALIZATION_ID = 2215;
	 ...
	 */
	List<IAllianceForumPost> getPostList();
	 ...
	 */
	void setPoster(IAllianceForumUser poster);
	 ...
	 */
	void setPostList(List<IAllianceForumPost> postList);
}
