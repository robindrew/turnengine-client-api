...
public class ExecuteTurnsReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public ExecuteTurnsReturnTypeJsonSerializer() {
		this("ExecuteTurnsReturnType");
	}

	public ExecuteTurnsReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
