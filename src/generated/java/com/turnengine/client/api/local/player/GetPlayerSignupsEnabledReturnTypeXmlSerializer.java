...
public class GetPlayerSignupsEnabledReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public GetPlayerSignupsEnabledReturnTypeXmlSerializer() {
		this("GetPlayerSignupsEnabledReturnType");
	}

	public GetPlayerSignupsEnabledReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
