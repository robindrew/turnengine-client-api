...
public class CheckRenameLocationReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public CheckRenameLocationReturnTypeXmlSerializer() {
		this("CheckRenameLocationReturnType");
	}

	public CheckRenameLocationReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
