...
public class GetGroupByIdReturnTypeJsonSerializer implements IJsonSerializer<IGroup> {

	private String name;

	public GetGroupByIdReturnTypeJsonSerializer() {
		this("GetGroupByIdReturnType");
	}

	public GetGroupByIdReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
