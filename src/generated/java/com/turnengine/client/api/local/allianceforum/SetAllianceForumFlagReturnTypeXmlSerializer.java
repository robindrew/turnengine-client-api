...
public class SetAllianceForumFlagReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetAllianceForumFlagReturnTypeXmlSerializer() {
		this("SetAllianceForumFlagReturnType");
	}

	public SetAllianceForumFlagReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
