...
public class AddParentGroup implements IAddParentGroup {
	 ...
	 */
	public AddParentGroup() {
	}

	/**
	 * The fields constructor.
	 */
	public AddParentGroup(long loginId, int instanceId, String name, String factionName) {
		setLoginId(loginId);
	 ...
	 */
	public AddParentGroup(IAddParentGroup clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IAddParentGroup that = (IAddParentGroup) object;
	...
	@Override
	public int compareTo(IAddParentGroup that) {
