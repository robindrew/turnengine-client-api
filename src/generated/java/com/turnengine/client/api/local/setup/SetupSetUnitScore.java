...
public class SetupSetUnitScore implements ISetupSetUnitScore {
	 ...
	 */
	public SetupSetUnitScore() {
	}

	/**
	 * The fields constructor.
	 */
	public SetupSetUnitScore(long loginId, int instanceId, String group, String unit, long score) {
		setLoginId(loginId);
	 ...
	 */
	public SetupSetUnitScore(ISetupSetUnitScore clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ISetupSetUnitScore that = (ISetupSetUnitScore) object;
	...
	@Override
	public int compareTo(ISetupSetUnitScore that) {
