...
public class SetLocationSignupsEnabledReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetLocationSignupsEnabledReturnTypeXmlSerializer() {
		this("SetLocationSignupsEnabledReturnType");
	}

	public SetLocationSignupsEnabledReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
