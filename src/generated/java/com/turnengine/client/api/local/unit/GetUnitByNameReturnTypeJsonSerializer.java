...
public class GetUnitByNameReturnTypeJsonSerializer implements IJsonSerializer<IUnit> {

	private String name;

	public GetUnitByNameReturnTypeJsonSerializer() {
		this("GetUnitByNameReturnType");
	}

	public GetUnitByNameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
