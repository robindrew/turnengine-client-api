...
public class GetPlayerByIdReturnTypeJsonSerializer implements IJsonSerializer<IPlayer> {

	private String name;

	public GetPlayerByIdReturnTypeJsonSerializer() {
		this("GetPlayerByIdReturnType");
	}

	public GetPlayerByIdReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
