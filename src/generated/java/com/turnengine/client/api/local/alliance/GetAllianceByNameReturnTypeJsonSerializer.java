...
public class GetAllianceByNameReturnTypeJsonSerializer implements IJsonSerializer<IAlliance> {

	private String name;

	public GetAllianceByNameReturnTypeJsonSerializer() {
		this("GetAllianceByNameReturnType");
	}

	public GetAllianceByNameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
