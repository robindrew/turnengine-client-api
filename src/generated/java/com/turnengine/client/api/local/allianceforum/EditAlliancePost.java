...
public class EditAlliancePost implements IEditAlliancePost {
	 ...
	 */
	public EditAlliancePost() {
	}

	/**
	 * The fields constructor.
	 */
	public EditAlliancePost(long loginId, int instanceId, int postId, String subject, String content) {
		setLoginId(loginId);
	 ...
	 */
	public EditAlliancePost(IEditAlliancePost clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IEditAlliancePost that = (IEditAlliancePost) object;
	...
	@Override
	public int compareTo(IEditAlliancePost that) {
