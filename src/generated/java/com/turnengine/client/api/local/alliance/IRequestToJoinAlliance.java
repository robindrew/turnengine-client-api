...
public interface IRequestToJoinAlliance extends IExecutableBean<Boolean>, ILocalLoggedInBean<Boolean>, Comparable<IRequestToJoinAlliance> {

	int SERIALIZATION_ID = 2109;
