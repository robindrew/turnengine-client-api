...
public class KickAllianceMemberReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public KickAllianceMemberReturnTypeXmlSerializer() {
		this("KickAllianceMemberReturnType");
	}

	public KickAllianceMemberReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
