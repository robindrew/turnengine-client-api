...
public class ListActionsQueuedAtLocationReturnTypeJsonSerializer implements IJsonSerializer<List<IActionQueued>> {

	private String name;

	public ListActionsQueuedAtLocationReturnTypeJsonSerializer() {
		this("ListActionsQueuedAtLocationReturnType");
	}

	public ListActionsQueuedAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
