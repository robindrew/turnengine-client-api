...
public class GetTurnNumberReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public GetTurnNumberReturnTypeJsonSerializer() {
		this("GetTurnNumberReturnType");
	}

	public GetTurnNumberReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
