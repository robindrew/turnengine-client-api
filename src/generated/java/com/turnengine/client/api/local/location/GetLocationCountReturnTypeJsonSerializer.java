...
public class GetLocationCountReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public GetLocationCountReturnTypeJsonSerializer() {
		this("GetLocationCountReturnType");
	}

	public GetLocationCountReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
