...
public class ListActionsQueuedAtPlayerReturnTypeXmlSerializer implements IXmlSerializer<List<IActionQueued>> {

	private String name;

	public ListActionsQueuedAtPlayerReturnTypeXmlSerializer() {
		this("ListActionsQueuedAtPlayerReturnType");
	}

	public ListActionsQueuedAtPlayerReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
