...
public class SetUnitScoreReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetUnitScoreReturnTypeJsonSerializer() {
		this("SetUnitScoreReturnType");
	}

	public SetUnitScoreReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
