...
public class GetAllianceByIdReturnTypeXmlSerializer implements IXmlSerializer<IAlliance> {

	private String name;

	public GetAllianceByIdReturnTypeXmlSerializer() {
		this("GetAllianceByIdReturnType");
	}

	public GetAllianceByIdReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
