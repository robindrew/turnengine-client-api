...
public class GetMobilesEnabledReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public GetMobilesEnabledReturnTypeJsonSerializer() {
		this("GetMobilesEnabledReturnType");
	}

	public GetMobilesEnabledReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
