...
public class GetAlliancePostList implements IGetAlliancePostList {
	 ...
	 */
	public GetAlliancePostList() {
	}

	/**
	 * The fields constructor.
	 */
	public GetAlliancePostList(long loginId, int instanceId, int threadId, int pageNumber, int pageSize) {
		setLoginId(loginId);
	 ...
	 */
	public GetAlliancePostList(IGetAlliancePostList clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetAlliancePostList that = (IGetAlliancePostList) object;
	...
	@Override
	public int compareTo(IGetAlliancePostList that) {
