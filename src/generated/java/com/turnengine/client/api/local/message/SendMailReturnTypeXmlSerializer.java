...
public class SendMailReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public SendMailReturnTypeXmlSerializer() {
		this("SendMailReturnType");
	}

	public SendMailReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
