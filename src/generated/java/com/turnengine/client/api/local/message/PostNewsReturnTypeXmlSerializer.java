...
public class PostNewsReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public PostNewsReturnTypeXmlSerializer() {
		this("PostNewsReturnType");
	}

	public PostNewsReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
