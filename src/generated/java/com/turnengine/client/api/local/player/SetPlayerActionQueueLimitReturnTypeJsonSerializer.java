...
public class SetPlayerActionQueueLimitReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public SetPlayerActionQueueLimitReturnTypeJsonSerializer() {
		this("SetPlayerActionQueueLimitReturnType");
	}

	public SetPlayerActionQueueLimitReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
