...
public class GetPlayerCountReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public GetPlayerCountReturnTypeJsonSerializer() {
		this("GetPlayerCountReturnType");
	}

	public GetPlayerCountReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
