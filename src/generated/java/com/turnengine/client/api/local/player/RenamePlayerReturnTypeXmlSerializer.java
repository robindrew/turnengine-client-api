...
public class RenamePlayerReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public RenamePlayerReturnTypeXmlSerializer() {
		this("RenamePlayerReturnType");
	}

	public RenamePlayerReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
