...
public class AddMoveRegionReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public AddMoveRegionReturnTypeXmlSerializer() {
		this("AddMoveRegionReturnType");
	}

	public AddMoveRegionReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
