...
public class ClearActionsQueuedAtLocation implements IClearActionsQueuedAtLocation {
	 ...
	 */
	public ClearActionsQueuedAtLocation() {
	}

	/**
	 * The fields constructor.
	 */
	public ClearActionsQueuedAtLocation(long loginId, int instanceId, int locationId, int groupId) {
		setLoginId(loginId);
	 ...
	 */
	public ClearActionsQueuedAtLocation(IClearActionsQueuedAtLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IClearActionsQueuedAtLocation that = (IClearActionsQueuedAtLocation) object;
	...
	@Override
	public int compareTo(IClearActionsQueuedAtLocation that) {
