...
public class GetLocationIdReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetLocationIdReturnTypeXmlSerializer() {
		this("GetLocationIdReturnType");
	}

	public GetLocationIdReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
