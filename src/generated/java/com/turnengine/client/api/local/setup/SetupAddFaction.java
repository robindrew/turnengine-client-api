...
public class SetupAddFaction implements ISetupAddFaction {
	 ...
	 */
	public SetupAddFaction() {
	}

	/**
	 * The fields constructor.
	 */
	public SetupAddFaction(String name, String password, FactionUnited united, int playerLimit) {
		setName(name);
	 ...
	 */
	public SetupAddFaction(ISetupAddFaction clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ISetupAddFaction that = (ISetupAddFaction) object;
	...
	@Override
	public int compareTo(ISetupAddFaction that) {
