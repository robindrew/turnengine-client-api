...
public class GetAllianceScoresReturnTypeJsonSerializer implements IJsonSerializer<List<ITurnScore>> {

	private String name;

	public GetAllianceScoresReturnTypeJsonSerializer() {
		this("GetAllianceScoresReturnType");
	}

	public GetAllianceScoresReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
