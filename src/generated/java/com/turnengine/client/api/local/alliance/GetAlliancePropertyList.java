...
public class GetAlliancePropertyList implements IGetAlliancePropertyList {
	 ...
	 */
	public GetAlliancePropertyList() {
	}

	/**
	 * The fields constructor.
	 */
	public GetAlliancePropertyList(long loginId, int instanceId, int allianceId) {
		setLoginId(loginId);
	 ...
	 */
	public GetAlliancePropertyList(IGetAlliancePropertyList clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetAlliancePropertyList that = (IGetAlliancePropertyList) object;
	...
	@Override
	public int compareTo(IGetAlliancePropertyList that) {
