...
public class SetSetupBeanListDirectoryReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetSetupBeanListDirectoryReturnTypeJsonSerializer() {
		this("SetSetupBeanListDirectoryReturnType");
	}

	public SetSetupBeanListDirectoryReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
