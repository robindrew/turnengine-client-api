...
public class SetMobilesEnabledReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetMobilesEnabledReturnTypeJsonSerializer() {
		this("SetMobilesEnabledReturnType");
	}

	public SetMobilesEnabledReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
