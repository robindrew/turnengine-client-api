...
public class AddActionPluginReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public AddActionPluginReturnTypeJsonSerializer() {
		this("AddActionPluginReturnType");
	}

	public AddActionPluginReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
