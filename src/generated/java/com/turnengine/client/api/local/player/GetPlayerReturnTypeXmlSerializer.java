...
public class GetPlayerReturnTypeXmlSerializer implements IXmlSerializer<IPlayer> {

	private String name;

	public GetPlayerReturnTypeXmlSerializer() {
		this("GetPlayerReturnType");
	}

	public GetPlayerReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
