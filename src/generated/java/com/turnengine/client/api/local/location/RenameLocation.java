...
public class RenameLocation implements IRenameLocation {
	 ...
	 */
	public RenameLocation(long loginId, int instanceId, int locationId, String name) {
		setLoginId(loginId);
	 ...
	 */
	public RenameLocation(IRenameLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IRenameLocation that = (IRenameLocation) object;
	...
	@Override
	public int compareTo(IRenameLocation that) {
