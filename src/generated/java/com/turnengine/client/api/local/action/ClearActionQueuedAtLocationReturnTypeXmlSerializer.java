...
public class ClearActionQueuedAtLocationReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public ClearActionQueuedAtLocationReturnTypeXmlSerializer() {
		this("ClearActionQueuedAtLocationReturnType");
	}

	public ClearActionQueuedAtLocationReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
