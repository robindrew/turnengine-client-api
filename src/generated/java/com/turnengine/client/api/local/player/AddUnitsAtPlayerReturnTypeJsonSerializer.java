...
public class AddUnitsAtPlayerReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public AddUnitsAtPlayerReturnTypeJsonSerializer() {
		this("AddUnitsAtPlayerReturnType");
	}

	public AddUnitsAtPlayerReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
