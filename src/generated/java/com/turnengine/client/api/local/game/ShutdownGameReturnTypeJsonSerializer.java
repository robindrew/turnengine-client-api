...
public class ShutdownGameReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ShutdownGameReturnTypeJsonSerializer() {
		this("ShutdownGameReturnType");
	}

	public ShutdownGameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
