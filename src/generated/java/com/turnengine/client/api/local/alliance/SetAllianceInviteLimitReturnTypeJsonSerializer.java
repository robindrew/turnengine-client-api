...
public class SetAllianceInviteLimitReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public SetAllianceInviteLimitReturnTypeJsonSerializer() {
		this("SetAllianceInviteLimitReturnType");
	}

	public SetAllianceInviteLimitReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
