...
public class SetAllianceLogoReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetAllianceLogoReturnTypeXmlSerializer() {
		this("SetAllianceLogoReturnType");
	}

	public SetAllianceLogoReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
