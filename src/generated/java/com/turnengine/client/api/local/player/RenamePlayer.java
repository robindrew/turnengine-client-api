...
public class RenamePlayer implements IRenamePlayer {
	 ...
	 */
	public RenamePlayer(long loginId, int instanceId, String from, String to) {
		setLoginId(loginId);
	 ...
	 */
	public RenamePlayer(IRenamePlayer clone) {
	...
	public void setFrom(String from) {
		...
		if (from.length() > 30) {
			throw new IllegalArgumentException("from too long, maximum of 30 characters, value: '" + from + "'");
		}
		this.from = from;
	}
	...
	public void setTo(String to) {
		...
		if (to.length() > 30) {
			throw new IllegalArgumentException("to too long, maximum of 30 characters, value: '" + to + "'");
		}
		this.to = to;
	}
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IRenamePlayer that = (IRenamePlayer) object;
	...
	@Override
	public int compareTo(IRenamePlayer that) {
