...
public class ClearActionQueuedAtLocationReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ClearActionQueuedAtLocationReturnTypeJsonSerializer() {
		this("ClearActionQueuedAtLocationReturnType");
	}

	public ClearActionQueuedAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
