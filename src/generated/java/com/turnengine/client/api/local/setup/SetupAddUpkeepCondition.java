...
public class SetupAddUpkeepCondition implements ISetupAddUpkeepCondition {
	 ...
	 */
	public SetupAddUpkeepCondition() {
	}

	/**
	 * The fields constructor.
	 */
	public SetupAddUpkeepCondition(String name, CreationConditionType condition, String conditionName1, long conditionAmount1, String conditionName2, long conditionAmount2, String conditionName3, long conditionAmount3, boolean optional) {
		setName(name);
	 ...
	 */
	public SetupAddUpkeepCondition(ISetupAddUpkeepCondition clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ISetupAddUpkeepCondition that = (ISetupAddUpkeepCondition) object;
	...
	@Override
	public int compareTo(ISetupAddUpkeepCondition that) {
