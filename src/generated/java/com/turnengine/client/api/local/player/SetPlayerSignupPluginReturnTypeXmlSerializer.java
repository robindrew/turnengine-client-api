...
public class SetPlayerSignupPluginReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetPlayerSignupPluginReturnTypeXmlSerializer() {
		this("SetPlayerSignupPluginReturnType");
	}

	public SetPlayerSignupPluginReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
