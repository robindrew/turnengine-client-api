...
public class GetLocationSignupsEnabledReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public GetLocationSignupsEnabledReturnTypeXmlSerializer() {
		this("GetLocationSignupsEnabledReturnType");
	}

	public GetLocationSignupsEnabledReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
