...
public class SetPlayerSignupsEnabledReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetPlayerSignupsEnabledReturnTypeJsonSerializer() {
		this("SetPlayerSignupsEnabledReturnType");
	}

	public SetPlayerSignupsEnabledReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
