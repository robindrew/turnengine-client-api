...
public class AddUnitsAtPlayerReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public AddUnitsAtPlayerReturnTypeXmlSerializer() {
		this("AddUnitsAtPlayerReturnType");
	}

	public AddUnitsAtPlayerReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
