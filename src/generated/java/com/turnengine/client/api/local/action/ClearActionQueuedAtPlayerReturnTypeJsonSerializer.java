...
public class ClearActionQueuedAtPlayerReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ClearActionQueuedAtPlayerReturnTypeJsonSerializer() {
		this("ClearActionQueuedAtPlayerReturnType");
	}

	public ClearActionQueuedAtPlayerReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
