...
public class GetScoreDivisorReturnTypeXmlSerializer implements IXmlSerializer<Long> {

	private String name;

	public GetScoreDivisorReturnTypeXmlSerializer() {
		this("GetScoreDivisorReturnType");
	}

	public GetScoreDivisorReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
