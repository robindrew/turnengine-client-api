...
public class CreateMobileAtLocationReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public CreateMobileAtLocationReturnTypeJsonSerializer() {
		this("CreateMobileAtLocationReturnType");
	}

	public CreateMobileAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
