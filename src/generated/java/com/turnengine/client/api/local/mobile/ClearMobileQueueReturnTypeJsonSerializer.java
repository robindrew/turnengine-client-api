...
public class ClearMobileQueueReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ClearMobileQueueReturnTypeJsonSerializer() {
		this("ClearMobileQueueReturnType");
	}

	public ClearMobileQueueReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
