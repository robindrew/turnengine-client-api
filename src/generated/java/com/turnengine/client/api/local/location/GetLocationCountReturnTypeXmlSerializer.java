...
public class GetLocationCountReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetLocationCountReturnTypeXmlSerializer() {
		this("GetLocationCountReturnType");
	}

	public GetLocationCountReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
