...
public class GetAllianceInviteLimitReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public GetAllianceInviteLimitReturnTypeJsonSerializer() {
		this("GetAllianceInviteLimitReturnType");
	}

	public GetAllianceInviteLimitReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
