...
public class InviteToJoinAllianceReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public InviteToJoinAllianceReturnTypeJsonSerializer() {
		this("InviteToJoinAllianceReturnType");
	}

	public InviteToJoinAllianceReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
