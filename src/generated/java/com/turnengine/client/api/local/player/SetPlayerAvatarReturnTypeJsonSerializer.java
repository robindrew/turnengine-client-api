...
public class SetPlayerAvatarReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetPlayerAvatarReturnTypeJsonSerializer() {
		this("SetPlayerAvatarReturnType");
	}

	public SetPlayerAvatarReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
