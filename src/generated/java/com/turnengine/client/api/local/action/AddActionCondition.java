...
public class AddActionCondition implements IAddActionCondition {
	 ...
	 */
	public AddActionCondition() {
	}

	/**
	 * The fields constructor.
	 */
	public AddActionCondition(long loginId, int instanceId, String name, ActionTargetType target, ActionConditionExecute execute, CreationConditionType condition, String conditionName1, long conditionAmount1, String conditionName2, long conditionAmount2, String conditionName3, long conditionAmount3, boolean optional) {
		setLoginId(loginId);
	 ...
	 */
	public AddActionCondition(IAddActionCondition clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IAddActionCondition that = (IAddActionCondition) object;
	...
	@Override
	public int compareTo(IAddActionCondition that) {
