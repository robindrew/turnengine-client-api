...
public class ListMobilesAtLocationReturnTypeJsonSerializer implements IJsonSerializer<List<IMobile>> {

	private String name;

	public ListMobilesAtLocationReturnTypeJsonSerializer() {
		this("ListMobilesAtLocationReturnType");
	}

	public ListMobilesAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
