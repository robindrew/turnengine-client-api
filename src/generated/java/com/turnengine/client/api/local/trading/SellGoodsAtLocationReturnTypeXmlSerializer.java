...
public class SellGoodsAtLocationReturnTypeXmlSerializer implements IXmlSerializer<ITrade> {

	private String name;

	public SellGoodsAtLocationReturnTypeXmlSerializer() {
		this("SellGoodsAtLocationReturnType");
	}

	public SellGoodsAtLocationReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
