...
public class PriceDataSerializer extends ObjectSerializer<IPrice> {

	public PriceDataSerializer() {
		super(false);
	}

	public PriceDataSerializer(boolean nullable) {
		super(nullable);
	}

	@Override
	public IPrice readValue(IDataReader reader) throws IOException {
	...
	@Override
	public void writeValue(IDataWriter writer, IPrice object) throws IOException {
