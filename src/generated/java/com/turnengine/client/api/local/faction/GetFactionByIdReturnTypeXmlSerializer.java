...
public class GetFactionByIdReturnTypeXmlSerializer implements IXmlSerializer<IFaction> {

	private String name;

	public GetFactionByIdReturnTypeXmlSerializer() {
		this("GetFactionByIdReturnType");
	}

	public GetFactionByIdReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
