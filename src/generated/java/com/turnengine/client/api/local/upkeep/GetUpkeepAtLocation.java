...
public class GetUpkeepAtLocation implements IGetUpkeepAtLocation {
	 ...
	 */
	public GetUpkeepAtLocation() {
	}

	/**
	 * The fields constructor.
	 */
	public GetUpkeepAtLocation(long loginId, int instanceId, int locationId) {
		setLoginId(loginId);
	 ...
	 */
	public GetUpkeepAtLocation(IGetUpkeepAtLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetUpkeepAtLocation that = (IGetUpkeepAtLocation) object;
	...
	@Override
	public int compareTo(IGetUpkeepAtLocation that) {
