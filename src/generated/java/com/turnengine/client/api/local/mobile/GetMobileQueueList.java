...
public class GetMobileQueueList implements IGetMobileQueueList {
	 ...
	 */
	public GetMobileQueueList() {
	}

	/**
	 * The fields constructor.
	 */
	public GetMobileQueueList(long loginId, int instanceId, int mobileId) {
		setLoginId(loginId);
	 ...
	 */
	public GetMobileQueueList(IGetMobileQueueList clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetMobileQueueList that = (IGetMobileQueueList) object;
	...
	@Override
	public int compareTo(IGetMobileQueueList that) {
