...
public class SetPlayerLimitReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public SetPlayerLimitReturnTypeXmlSerializer() {
		this("SetPlayerLimitReturnType");
	}

	public SetPlayerLimitReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
