...
public class CheckRenameLocation implements ICheckRenameLocation {
	 ...
	 */
	public CheckRenameLocation() {
	}

	/**
	 * The fields constructor.
	 */
	public CheckRenameLocation(long loginId, int instanceId, int locationId, String name) {
		setLoginId(loginId);
	 ...
	 */
	public CheckRenameLocation(ICheckRenameLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ICheckRenameLocation that = (ICheckRenameLocation) object;
	...
	@Override
	public int compareTo(ICheckRenameLocation that) {
