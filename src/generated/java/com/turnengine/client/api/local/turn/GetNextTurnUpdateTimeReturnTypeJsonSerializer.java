...
public class GetNextTurnUpdateTimeReturnTypeJsonSerializer implements IJsonSerializer<Long> {

	private String name;

	public GetNextTurnUpdateTimeReturnTypeJsonSerializer() {
		this("GetNextTurnUpdateTimeReturnType");
	}

	public GetNextTurnUpdateTimeReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
