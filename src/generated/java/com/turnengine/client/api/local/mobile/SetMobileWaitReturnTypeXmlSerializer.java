...
public class SetMobileWaitReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetMobileWaitReturnTypeXmlSerializer() {
		this("SetMobileWaitReturnType");
	}

	public SetMobileWaitReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
