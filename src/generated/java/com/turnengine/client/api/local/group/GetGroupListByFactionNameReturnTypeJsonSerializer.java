...
public class GetGroupListByFactionNameReturnTypeJsonSerializer implements IJsonSerializer<List<IGroup>> {

	private String name;

	public GetGroupListByFactionNameReturnTypeJsonSerializer() {
		this("GetGroupListByFactionNameReturnType");
	}

	public GetGroupListByFactionNameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
