...
public class GetLocationCoordinatePluginReturnTypeJsonSerializer implements IJsonSerializer<IPluginDetails> {

	private String name;

	public GetLocationCoordinatePluginReturnTypeJsonSerializer() {
		this("GetLocationCoordinatePluginReturnType");
	}

	public GetLocationCoordinatePluginReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
