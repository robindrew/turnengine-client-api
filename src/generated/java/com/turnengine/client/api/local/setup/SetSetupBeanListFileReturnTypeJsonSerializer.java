...
public class SetSetupBeanListFileReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetSetupBeanListFileReturnTypeJsonSerializer() {
		this("SetSetupBeanListFileReturnType");
	}

	public SetSetupBeanListFileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
