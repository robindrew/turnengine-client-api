...
public class GetPlayerCountByFactionIdReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetPlayerCountByFactionIdReturnTypeXmlSerializer() {
		this("GetPlayerCountByFactionIdReturnType");
	}

	public GetPlayerCountByFactionIdReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
