...
public class ClearMobileQueueReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public ClearMobileQueueReturnTypeXmlSerializer() {
		this("ClearMobileQueueReturnType");
	}

	public ClearMobileQueueReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
