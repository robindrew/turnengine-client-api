...
public class GetFactionByNameReturnTypeJsonSerializer implements IJsonSerializer<IFaction> {

	private String name;

	public GetFactionByNameReturnTypeJsonSerializer() {
		this("GetFactionByNameReturnType");
	}

	public GetFactionByNameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
