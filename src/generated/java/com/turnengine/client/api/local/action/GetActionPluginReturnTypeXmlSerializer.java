...
public class GetActionPluginReturnTypeXmlSerializer implements IXmlSerializer<IPluginDetails> {

	private String name;

	public GetActionPluginReturnTypeXmlSerializer() {
		this("GetActionPluginReturnType");
	}

	public GetActionPluginReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
