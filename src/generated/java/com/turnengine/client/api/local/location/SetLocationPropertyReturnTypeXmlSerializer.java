...
public class SetLocationPropertyReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetLocationPropertyReturnTypeXmlSerializer() {
		this("SetLocationPropertyReturnType");
	}

	public SetLocationPropertyReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
