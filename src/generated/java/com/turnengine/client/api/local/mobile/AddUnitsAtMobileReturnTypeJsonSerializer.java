...
public class AddUnitsAtMobileReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public AddUnitsAtMobileReturnTypeJsonSerializer() {
		this("AddUnitsAtMobileReturnType");
	}

	public AddUnitsAtMobileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
