...
public class GetRequestedToJoinAllianceListReturnTypeJsonSerializer implements IJsonSerializer<List<IPlayerInfo>> {

	private String name;

	public GetRequestedToJoinAllianceListReturnTypeJsonSerializer() {
		this("GetRequestedToJoinAllianceListReturnType");
	}

	public GetRequestedToJoinAllianceListReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
