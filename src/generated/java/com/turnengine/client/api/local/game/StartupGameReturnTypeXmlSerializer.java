...
public class StartupGameReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public StartupGameReturnTypeXmlSerializer() {
		this("StartupGameReturnType");
	}

	public StartupGameReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
