...
public class SetLocationsEnabledReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetLocationsEnabledReturnTypeXmlSerializer() {
		this("SetLocationsEnabledReturnType");
	}

	public SetLocationsEnabledReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
