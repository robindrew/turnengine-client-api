...
public class SellGoodsAtLocationReturnTypeJsonSerializer implements IJsonSerializer<ITrade> {

	private String name;

	public SellGoodsAtLocationReturnTypeJsonSerializer() {
		this("SellGoodsAtLocationReturnType");
	}

	public SellGoodsAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
