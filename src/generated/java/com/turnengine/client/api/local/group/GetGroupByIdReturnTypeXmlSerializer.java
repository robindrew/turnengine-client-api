...
public class GetGroupByIdReturnTypeXmlSerializer implements IXmlSerializer<IGroup> {

	private String name;

	public GetGroupByIdReturnTypeXmlSerializer() {
		this("GetGroupByIdReturnType");
	}

	public GetGroupByIdReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
