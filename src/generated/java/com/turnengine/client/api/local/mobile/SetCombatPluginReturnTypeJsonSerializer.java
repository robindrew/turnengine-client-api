...
public class SetCombatPluginReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetCombatPluginReturnTypeJsonSerializer() {
		this("SetCombatPluginReturnType");
	}

	public SetCombatPluginReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
