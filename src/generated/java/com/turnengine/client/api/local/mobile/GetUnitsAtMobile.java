...
public class GetUnitsAtMobile implements IGetUnitsAtMobile {
	 ...
	 */
	public GetUnitsAtMobile() {
	}

	/**
	 * The fields constructor.
	 */
	public GetUnitsAtMobile(long loginId, int instanceId, int mobileId) {
		setLoginId(loginId);
	 ...
	 */
	public GetUnitsAtMobile(IGetUnitsAtMobile clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetUnitsAtMobile that = (IGetUnitsAtMobile) object;
	...
	@Override
	public int compareTo(IGetUnitsAtMobile that) {
