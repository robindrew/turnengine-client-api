...
public class ClearActionsQueuedAtLocationReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public ClearActionsQueuedAtLocationReturnTypeXmlSerializer() {
		this("ClearActionsQueuedAtLocationReturnType");
	}

	public ClearActionsQueuedAtLocationReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
