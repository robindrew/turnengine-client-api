...
public class AddUnitsAtMobileReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public AddUnitsAtMobileReturnTypeXmlSerializer() {
		this("AddUnitsAtMobileReturnType");
	}

	public AddUnitsAtMobileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
