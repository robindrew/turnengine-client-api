...
public class AddFactionReturnTypeXmlSerializer implements IXmlSerializer<IFaction> {

	private String name;

	public AddFactionReturnTypeXmlSerializer() {
		this("AddFactionReturnType");
	}

	public AddFactionReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
