...
public class DestroyEmptyMobile implements IDestroyEmptyMobile {
	 ...
	 */
	public DestroyEmptyMobile() {
	}

	/**
	 * The fields constructor.
	 */
	public DestroyEmptyMobile(long loginId, int instanceId, int mobileId) {
		setLoginId(loginId);
	 ...
	 */
	public DestroyEmptyMobile(IDestroyEmptyMobile clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IDestroyEmptyMobile that = (IDestroyEmptyMobile) object;
	...
	@Override
	public int compareTo(IDestroyEmptyMobile that) {
