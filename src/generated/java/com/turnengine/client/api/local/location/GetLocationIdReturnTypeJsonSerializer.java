...
public class GetLocationIdReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public GetLocationIdReturnTypeJsonSerializer() {
		this("GetLocationIdReturnType");
	}

	public GetLocationIdReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
