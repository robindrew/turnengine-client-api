...
public class RequestToJoinAllianceReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public RequestToJoinAllianceReturnTypeJsonSerializer() {
		this("RequestToJoinAllianceReturnType");
	}

	public RequestToJoinAllianceReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
