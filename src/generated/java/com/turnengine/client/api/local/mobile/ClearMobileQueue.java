...
public class ClearMobileQueue implements IClearMobileQueue {
	 ...
	 */
	public ClearMobileQueue() {
	}

	/**
	 * The fields constructor.
	 */
	public ClearMobileQueue(long loginId, int instanceId, int mobileId) {
		setLoginId(loginId);
	 ...
	 */
	public ClearMobileQueue(IClearMobileQueue clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IClearMobileQueue that = (IClearMobileQueue) object;
	...
	@Override
	public int compareTo(IClearMobileQueue that) {
