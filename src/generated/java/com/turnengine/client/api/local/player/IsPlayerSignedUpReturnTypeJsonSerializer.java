...
public class IsPlayerSignedUpReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public IsPlayerSignedUpReturnTypeJsonSerializer() {
		this("IsPlayerSignedUpReturnType");
	}

	public IsPlayerSignedUpReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
