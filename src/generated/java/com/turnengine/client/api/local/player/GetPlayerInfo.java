...
public class GetPlayerInfo implements IGetPlayerInfo {
	 ...
	 */
	public GetPlayerInfo(long loginId, int instanceId, int playerId) {
		setLoginId(loginId);
	 ...
	 */
	public GetPlayerInfo(IGetPlayerInfo clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetPlayerInfo that = (IGetPlayerInfo) object;
	...
	@Override
	public int compareTo(IGetPlayerInfo that) {
