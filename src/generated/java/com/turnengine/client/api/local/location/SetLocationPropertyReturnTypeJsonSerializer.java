...
public class SetLocationPropertyReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetLocationPropertyReturnTypeJsonSerializer() {
		this("SetLocationPropertyReturnType");
	}

	public SetLocationPropertyReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
