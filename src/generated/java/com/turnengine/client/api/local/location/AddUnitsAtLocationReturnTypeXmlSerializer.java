...
public class AddUnitsAtLocationReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public AddUnitsAtLocationReturnTypeXmlSerializer() {
		this("AddUnitsAtLocationReturnType");
	}

	public AddUnitsAtLocationReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
