...
public class AddMoveRegionReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public AddMoveRegionReturnTypeJsonSerializer() {
		this("AddMoveRegionReturnType");
	}

	public AddMoveRegionReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
