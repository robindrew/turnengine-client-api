...
public class GetUnitsByFactionNameReturnTypeXmlSerializer implements IXmlSerializer<List<IUnit>> {

	private String name;

	public GetUnitsByFactionNameReturnTypeXmlSerializer() {
		this("GetUnitsByFactionNameReturnType");
	}

	public GetUnitsByFactionNameReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
