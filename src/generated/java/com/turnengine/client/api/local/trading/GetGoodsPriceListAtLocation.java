...
public class GetGoodsPriceListAtLocation implements IGetGoodsPriceListAtLocation {
	 ...
	 */
	public GetGoodsPriceListAtLocation() {
	}

	/**
	 * The fields constructor.
	 */
	public GetGoodsPriceListAtLocation(long loginId, int instanceId, int locationId) {
		setLoginId(loginId);
	 ...
	 */
	public GetGoodsPriceListAtLocation(IGetGoodsPriceListAtLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetGoodsPriceListAtLocation that = (IGetGoodsPriceListAtLocation) object;
	...
	@Override
	public int compareTo(IGetGoodsPriceListAtLocation that) {
