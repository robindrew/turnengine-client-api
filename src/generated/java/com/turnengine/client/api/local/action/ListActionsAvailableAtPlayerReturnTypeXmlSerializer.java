...
public class ListActionsAvailableAtPlayerReturnTypeXmlSerializer implements IXmlSerializer<List<IActionAvailable>> {

	private String name;

	public ListActionsAvailableAtPlayerReturnTypeXmlSerializer() {
		this("ListActionsAvailableAtPlayerReturnType");
	}

	public ListActionsAvailableAtPlayerReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
