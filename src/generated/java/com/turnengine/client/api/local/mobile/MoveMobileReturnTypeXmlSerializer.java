...
public class MoveMobileReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public MoveMobileReturnTypeXmlSerializer() {
		this("MoveMobileReturnType");
	}

	public MoveMobileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
