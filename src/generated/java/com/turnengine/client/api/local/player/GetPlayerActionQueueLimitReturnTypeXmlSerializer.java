...
public class GetPlayerActionQueueLimitReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetPlayerActionQueueLimitReturnTypeXmlSerializer() {
		this("GetPlayerActionQueueLimitReturnType");
	}

	public GetPlayerActionQueueLimitReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
