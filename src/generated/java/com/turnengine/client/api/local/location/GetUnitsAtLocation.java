...
public class GetUnitsAtLocation implements IGetUnitsAtLocation {
	 ...
	 */
	public GetUnitsAtLocation() {
	}

	/**
	 * The fields constructor.
	 */
	public GetUnitsAtLocation(long loginId, int instanceId, int locationId) {
		setLoginId(loginId);
	 ...
	 */
	public GetUnitsAtLocation(IGetUnitsAtLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetUnitsAtLocation that = (IGetUnitsAtLocation) object;
	...
	@Override
	public int compareTo(IGetUnitsAtLocation that) {
