...
public class ListMobilesAtLocation implements IListMobilesAtLocation {
	 ...
	 */
	public ListMobilesAtLocation() {
	}

	/**
	 * The fields constructor.
	 */
	public ListMobilesAtLocation(long loginId, int instanceId, int locationId) {
		setLoginId(loginId);
	 ...
	 */
	public ListMobilesAtLocation(IListMobilesAtLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IListMobilesAtLocation that = (IListMobilesAtLocation) object;
	...
	@Override
	public int compareTo(IListMobilesAtLocation that) {
