...
public class CheckRenameLocationReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public CheckRenameLocationReturnTypeJsonSerializer() {
		this("CheckRenameLocationReturnType");
	}

	public CheckRenameLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
