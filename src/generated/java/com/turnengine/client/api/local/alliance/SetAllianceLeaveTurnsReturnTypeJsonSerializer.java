...
public class SetAllianceLeaveTurnsReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public SetAllianceLeaveTurnsReturnTypeJsonSerializer() {
		this("SetAllianceLeaveTurnsReturnType");
	}

	public SetAllianceLeaveTurnsReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
