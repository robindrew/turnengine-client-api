...
public class GetUnitsAtMobileReturnTypeJsonSerializer implements IJsonSerializer<List<IUnitCount>> {

	private String name;

	public GetUnitsAtMobileReturnTypeJsonSerializer() {
		this("GetUnitsAtMobileReturnType");
	}

	public GetUnitsAtMobileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
