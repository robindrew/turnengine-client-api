...
public class SetAllianceThreadFlagReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetAllianceThreadFlagReturnTypeJsonSerializer() {
		this("SetAllianceThreadFlagReturnType");
	}

	public SetAllianceThreadFlagReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
