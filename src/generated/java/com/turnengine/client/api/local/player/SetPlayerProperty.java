...
public class SetPlayerProperty implements ISetPlayerProperty {
	 ...
	 */
	public SetPlayerProperty(long loginId, int instanceId, int playerId, String key, String value) {
		setLoginId(loginId);
	 ...
	 */
	public SetPlayerProperty(ISetPlayerProperty clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ISetPlayerProperty that = (ISetPlayerProperty) object;
	...
	@Override
	public int compareTo(ISetPlayerProperty that) {
