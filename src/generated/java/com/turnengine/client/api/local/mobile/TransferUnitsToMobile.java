...
public class TransferUnitsToMobile implements ITransferUnitsToMobile {
	 ...
	 */
	public TransferUnitsToMobile() {
	}

	/**
	 * The fields constructor.
	 */
	public TransferUnitsToMobile(long loginId, int instanceId, int mobileId, List<IUnitCount> unitList, boolean addToQueue, boolean repeat) {
		setLoginId(loginId);
	 ...
	 */
	public TransferUnitsToMobile(ITransferUnitsToMobile clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ITransferUnitsToMobile that = (ITransferUnitsToMobile) object;
	...
	@Override
	public int compareTo(ITransferUnitsToMobile that) {
