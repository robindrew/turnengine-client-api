...
public class SetLocationGenerationPluginReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetLocationGenerationPluginReturnTypeXmlSerializer() {
		this("SetLocationGenerationPluginReturnType");
	}

	public SetLocationGenerationPluginReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
