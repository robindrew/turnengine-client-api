...
public class SetStorageGroupReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetStorageGroupReturnTypeJsonSerializer() {
		this("SetStorageGroupReturnType");
	}

	public SetStorageGroupReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
