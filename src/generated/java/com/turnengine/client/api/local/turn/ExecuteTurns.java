...
public class ExecuteTurns implements IExecuteTurns {
	 ...
	 */
	public ExecuteTurns(long loginId, int instanceId, int turns) {
		setLoginId(loginId);
	 ...
	 */
	public ExecuteTurns(IExecuteTurns clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IExecuteTurns that = (IExecuteTurns) object;
	...
	@Override
	public int compareTo(IExecuteTurns that) {
