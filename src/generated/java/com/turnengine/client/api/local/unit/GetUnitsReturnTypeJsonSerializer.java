...
public class GetUnitsReturnTypeJsonSerializer implements IJsonSerializer<List<IUnit>> {

	private String name;

	public GetUnitsReturnTypeJsonSerializer() {
		this("GetUnitsReturnType");
	}

	public GetUnitsReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
