...
public class GetPlayerActionQueueLimitReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public GetPlayerActionQueueLimitReturnTypeJsonSerializer() {
		this("GetPlayerActionQueueLimitReturnType");
	}

	public GetPlayerActionQueueLimitReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
