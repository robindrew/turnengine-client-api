...
public class InviteToJoinAllianceByNameReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public InviteToJoinAllianceByNameReturnTypeXmlSerializer() {
		this("InviteToJoinAllianceByNameReturnType");
	}

	public InviteToJoinAllianceByNameReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
