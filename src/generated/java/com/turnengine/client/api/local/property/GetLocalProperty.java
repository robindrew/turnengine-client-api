...
public class GetLocalProperty implements IGetLocalProperty {
	 ...
	 */
	public GetLocalProperty() {
	}

	/**
	 * The fields constructor.
	 */
	public GetLocalProperty(long loginId, int instanceId, String key) {
		setLoginId(loginId);
	 ...
	 */
	public GetLocalProperty(IGetLocalProperty clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetLocalProperty that = (IGetLocalProperty) object;
	...
	@Override
	public int compareTo(IGetLocalProperty that) {
