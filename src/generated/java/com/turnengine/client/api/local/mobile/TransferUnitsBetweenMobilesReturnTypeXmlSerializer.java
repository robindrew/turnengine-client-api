...
public class TransferUnitsBetweenMobilesReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public TransferUnitsBetweenMobilesReturnTypeXmlSerializer() {
		this("TransferUnitsBetweenMobilesReturnType");
	}

	public TransferUnitsBetweenMobilesReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
