...
public class MakeNoteReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public MakeNoteReturnTypeXmlSerializer() {
		this("MakeNoteReturnType");
	}

	public MakeNoteReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
