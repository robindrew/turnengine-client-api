...
public class SetTurnIntervalTimeReturnTypeJsonSerializer implements IJsonSerializer<Long> {

	private String name;

	public SetTurnIntervalTimeReturnTypeJsonSerializer() {
		this("SetTurnIntervalTimeReturnType");
	}

	public SetTurnIntervalTimeReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
