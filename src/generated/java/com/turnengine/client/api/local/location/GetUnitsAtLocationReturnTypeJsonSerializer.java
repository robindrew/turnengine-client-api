...
public class GetUnitsAtLocationReturnTypeJsonSerializer implements IJsonSerializer<List<IUnitCount>> {

	private String name;

	public GetUnitsAtLocationReturnTypeJsonSerializer() {
		this("GetUnitsAtLocationReturnType");
	}

	public GetUnitsAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
