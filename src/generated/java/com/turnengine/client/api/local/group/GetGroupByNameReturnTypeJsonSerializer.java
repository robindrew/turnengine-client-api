...
public class GetGroupByNameReturnTypeJsonSerializer implements IJsonSerializer<IGroup> {

	private String name;

	public GetGroupByNameReturnTypeJsonSerializer() {
		this("GetGroupByNameReturnType");
	}

	public GetGroupByNameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
