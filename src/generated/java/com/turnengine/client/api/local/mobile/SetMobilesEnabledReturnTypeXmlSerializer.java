...
public class SetMobilesEnabledReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetMobilesEnabledReturnTypeXmlSerializer() {
		this("SetMobilesEnabledReturnType");
	}

	public SetMobilesEnabledReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
