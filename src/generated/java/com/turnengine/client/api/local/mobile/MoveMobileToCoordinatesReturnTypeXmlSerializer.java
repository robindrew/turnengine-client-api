...
public class MoveMobileToCoordinatesReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public MoveMobileToCoordinatesReturnTypeXmlSerializer() {
		this("MoveMobileToCoordinatesReturnType");
	}

	public MoveMobileToCoordinatesReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
