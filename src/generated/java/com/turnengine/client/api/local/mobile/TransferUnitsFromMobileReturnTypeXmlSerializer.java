...
public class TransferUnitsFromMobileReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public TransferUnitsFromMobileReturnTypeXmlSerializer() {
		this("TransferUnitsFromMobileReturnType");
	}

	public TransferUnitsFromMobileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
