...
public class SetMobileMoveReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetMobileMoveReturnTypeJsonSerializer() {
		this("SetMobileMoveReturnType");
	}

	public SetMobileMoveReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
