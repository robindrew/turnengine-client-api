...
public class GetUnitsReturnTypeXmlSerializer implements IXmlSerializer<List<IUnit>> {

	private String name;

	public GetUnitsReturnTypeXmlSerializer() {
		this("GetUnitsReturnType");
	}

	public GetUnitsReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
