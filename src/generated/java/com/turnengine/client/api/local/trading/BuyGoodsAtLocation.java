...
public class BuyGoodsAtLocation implements IBuyGoodsAtLocation {
	 ...
	 */
	public BuyGoodsAtLocation() {
	}

	/**
	 * The fields constructor.
	 */
	public BuyGoodsAtLocation(long loginId, int instanceId, int locationId, int goodsId, long goodsAmount, int currencyId) {
		setLoginId(loginId);
	 ...
	 */
	public BuyGoodsAtLocation(IBuyGoodsAtLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IBuyGoodsAtLocation that = (IBuyGoodsAtLocation) object;
	...
	@Override
	public int compareTo(IBuyGoodsAtLocation that) {
