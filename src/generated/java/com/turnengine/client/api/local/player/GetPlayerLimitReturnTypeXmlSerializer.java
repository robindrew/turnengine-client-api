...
public class GetPlayerLimitReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetPlayerLimitReturnTypeXmlSerializer() {
		this("GetPlayerLimitReturnType");
	}

	public GetPlayerLimitReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
