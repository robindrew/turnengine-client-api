...
public class TransferUnitsFromMobileXmlSerializer implements IXmlSerializer<ITransferUnitsFromMobile> {

	private String name;

	public TransferUnitsFromMobileXmlSerializer() {
		this("TransferUnitsFromMobile");
	}

	public TransferUnitsFromMobileXmlSerializer(String name) {
		this.name = name;
	}
	...
	@Override
	public ITransferUnitsFromMobile readObject(IXmlReader reader) {
	...
	@Override
	public void writeObject(IXmlWriter writer, ITransferUnitsFromMobile object) {
