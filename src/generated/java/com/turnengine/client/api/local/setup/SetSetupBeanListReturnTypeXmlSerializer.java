...
public class SetSetupBeanListReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetSetupBeanListReturnTypeXmlSerializer() {
		this("SetSetupBeanListReturnType");
	}

	public SetSetupBeanListReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
