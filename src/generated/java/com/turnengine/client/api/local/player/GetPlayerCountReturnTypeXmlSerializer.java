...
public class GetPlayerCountReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetPlayerCountReturnTypeXmlSerializer() {
		this("GetPlayerCountReturnType");
	}

	public GetPlayerCountReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
