...
public class AddUnitsAtLocationReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public AddUnitsAtLocationReturnTypeJsonSerializer() {
		this("AddUnitsAtLocationReturnType");
	}

	public AddUnitsAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
