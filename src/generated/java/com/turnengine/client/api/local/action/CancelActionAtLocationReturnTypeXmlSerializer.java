...
public class CancelActionAtLocationReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public CancelActionAtLocationReturnTypeXmlSerializer() {
		this("CancelActionAtLocationReturnType");
	}

	public CancelActionAtLocationReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
