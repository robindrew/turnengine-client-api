...
public class RequestToJoinAllianceReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public RequestToJoinAllianceReturnTypeXmlSerializer() {
		this("RequestToJoinAllianceReturnType");
	}

	public RequestToJoinAllianceReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
