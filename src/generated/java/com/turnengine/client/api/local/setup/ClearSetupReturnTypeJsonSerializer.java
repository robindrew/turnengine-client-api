...
public class ClearSetupReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public ClearSetupReturnTypeJsonSerializer() {
		this("ClearSetupReturnType");
	}

	public ClearSetupReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
