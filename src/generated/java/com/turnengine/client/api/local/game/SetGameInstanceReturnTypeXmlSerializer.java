...
public class SetGameInstanceReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetGameInstanceReturnTypeXmlSerializer() {
		this("SetGameInstanceReturnType");
	}

	public SetGameInstanceReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
