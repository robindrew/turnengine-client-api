...
public class GetMobilePropertyList implements IGetMobilePropertyList {
	 ...
	 */
	public GetMobilePropertyList() {
	}

	/**
	 * The fields constructor.
	 */
	public GetMobilePropertyList(long loginId, int instanceId, int mobileId) {
		setLoginId(loginId);
	 ...
	 */
	public GetMobilePropertyList(IGetMobilePropertyList clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IGetMobilePropertyList that = (IGetMobilePropertyList) object;
	...
	@Override
	public int compareTo(IGetMobilePropertyList that) {
