...
public class SetAllianceLeaveTurnsReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public SetAllianceLeaveTurnsReturnTypeXmlSerializer() {
		this("SetAllianceLeaveTurnsReturnType");
	}

	public SetAllianceLeaveTurnsReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
