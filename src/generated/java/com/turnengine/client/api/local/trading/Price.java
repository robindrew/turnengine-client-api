...
public class Price implements IPrice {
	 ...
	 */
	public Price(TradingType type, int goodsId, long goodsAmount, int currencyId, long currencyAmount) {
		setType(type);
		setGoodsId(goodsId);
	...
	@Override
	public int compareTo(IPrice that) {
