...
public class GetAllianceThreadReturnTypeXmlSerializer implements IXmlSerializer<IAllianceForumThread> {

	private String name;

	public GetAllianceThreadReturnTypeXmlSerializer() {
		this("GetAllianceThreadReturnType");
	}

	public GetAllianceThreadReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
