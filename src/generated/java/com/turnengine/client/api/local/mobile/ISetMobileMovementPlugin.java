...
public interface ISetMobileMovementPlugin extends IExecutableBean<Boolean>, ILocalLoggedInBean<Boolean>, ISetupBean<Boolean>, Comparable<ISetMobileMovementPlugin> {

	int SERIALIZATION_ID = 5921;
