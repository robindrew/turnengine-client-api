...
public class CancelActionAtLocationReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public CancelActionAtLocationReturnTypeJsonSerializer() {
		this("CancelActionAtLocationReturnType");
	}

	public CancelActionAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
