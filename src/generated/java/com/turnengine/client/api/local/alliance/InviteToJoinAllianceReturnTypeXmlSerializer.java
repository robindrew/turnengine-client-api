...
public class InviteToJoinAllianceReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public InviteToJoinAllianceReturnTypeXmlSerializer() {
		this("InviteToJoinAllianceReturnType");
	}

	public InviteToJoinAllianceReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
