...
public class AddUpkeepCondition implements IAddUpkeepCondition {
	 ...
	 */
	public AddUpkeepCondition(long loginId, int instanceId, String name, CreationConditionType condition, String conditionName1, long conditionAmount1, String conditionName2, long conditionAmount2, String conditionName3, long conditionAmount3, boolean optional) {
		setLoginId(loginId);
	 ...
	 */
	public AddUpkeepCondition(IAddUpkeepCondition clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IAddUpkeepCondition that = (IAddUpkeepCondition) object;
	...
	@Override
	public int compareTo(IAddUpkeepCondition that) {
