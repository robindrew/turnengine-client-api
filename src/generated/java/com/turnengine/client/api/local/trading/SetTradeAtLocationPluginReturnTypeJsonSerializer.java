...
public class SetTradeAtLocationPluginReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetTradeAtLocationPluginReturnTypeJsonSerializer() {
		this("SetTradeAtLocationPluginReturnType");
	}

	public SetTradeAtLocationPluginReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
