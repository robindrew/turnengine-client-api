...
public class RenameMobileReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public RenameMobileReturnTypeJsonSerializer() {
		this("RenameMobileReturnType");
	}

	public RenameMobileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
