...
public class CreateMobileAtMobileReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public CreateMobileAtMobileReturnTypeXmlSerializer() {
		this("CreateMobileAtMobileReturnType");
	}

	public CreateMobileAtMobileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
