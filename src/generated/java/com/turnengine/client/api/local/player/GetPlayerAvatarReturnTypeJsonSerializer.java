...
public class GetPlayerAvatarReturnTypeJsonSerializer implements IJsonSerializer<IImage> {

	private String name;

	public GetPlayerAvatarReturnTypeJsonSerializer() {
		this("GetPlayerAvatarReturnType");
	}

	public GetPlayerAvatarReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
