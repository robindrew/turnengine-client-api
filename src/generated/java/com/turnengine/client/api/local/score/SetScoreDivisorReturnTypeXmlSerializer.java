...
public class SetScoreDivisorReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetScoreDivisorReturnTypeXmlSerializer() {
		this("SetScoreDivisorReturnType");
	}

	public SetScoreDivisorReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
