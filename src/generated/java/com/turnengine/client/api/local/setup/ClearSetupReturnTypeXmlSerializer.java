...
public class ClearSetupReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public ClearSetupReturnTypeXmlSerializer() {
		this("ClearSetupReturnType");
	}

	public ClearSetupReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
