...
public class SetAllianceLogoReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetAllianceLogoReturnTypeJsonSerializer() {
		this("SetAllianceLogoReturnType");
	}

	public SetAllianceLogoReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
