...
public class SetAllianceThreadFlagReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetAllianceThreadFlagReturnTypeXmlSerializer() {
		this("SetAllianceThreadFlagReturnType");
	}

	public SetAllianceThreadFlagReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
