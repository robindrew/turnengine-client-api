...
public class CreateAllianceForum implements ICreateAllianceForum {
	 ...
	 */
	public CreateAllianceForum() {
	}

	/**
	 * The fields constructor.
	 */
	public CreateAllianceForum(long loginId, int instanceId, String name, int parent) {
		setLoginId(loginId);
	 ...
	 */
	public CreateAllianceForum(ICreateAllianceForum clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ICreateAllianceForum that = (ICreateAllianceForum) object;
	...
	@Override
	public int compareTo(ICreateAllianceForum that) {
