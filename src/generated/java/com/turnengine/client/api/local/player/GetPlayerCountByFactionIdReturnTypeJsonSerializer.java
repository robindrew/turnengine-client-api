...
public class GetPlayerCountByFactionIdReturnTypeJsonSerializer implements IJsonSerializer<Integer> {

	private String name;

	public GetPlayerCountByFactionIdReturnTypeJsonSerializer() {
		this("GetPlayerCountByFactionIdReturnType");
	}

	public GetPlayerCountByFactionIdReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
