...
public class GetLocationsEnabledReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public GetLocationsEnabledReturnTypeXmlSerializer() {
		this("GetLocationsEnabledReturnType");
	}

	public GetLocationsEnabledReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
