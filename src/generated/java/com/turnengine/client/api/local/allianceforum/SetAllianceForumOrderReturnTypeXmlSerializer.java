...
public class SetAllianceForumOrderReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetAllianceForumOrderReturnTypeXmlSerializer() {
		this("SetAllianceForumOrderReturnType");
	}

	public SetAllianceForumOrderReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
