...
public class RenameMobileReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public RenameMobileReturnTypeXmlSerializer() {
		this("RenameMobileReturnType");
	}

	public RenameMobileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
