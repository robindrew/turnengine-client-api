...
public class GetLocationSignupsEnabledReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public GetLocationSignupsEnabledReturnTypeJsonSerializer() {
		this("GetLocationSignupsEnabledReturnType");
	}

	public GetLocationSignupsEnabledReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
