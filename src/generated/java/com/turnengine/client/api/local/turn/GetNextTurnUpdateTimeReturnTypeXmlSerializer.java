...
public class GetNextTurnUpdateTimeReturnTypeXmlSerializer implements IXmlSerializer<Long> {

	private String name;

	public GetNextTurnUpdateTimeReturnTypeXmlSerializer() {
		this("GetNextTurnUpdateTimeReturnType");
	}

	public GetNextTurnUpdateTimeReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
