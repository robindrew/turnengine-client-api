...
public class GetUnitsByGroupNameReturnTypeJsonSerializer implements IJsonSerializer<List<IUnit>> {

	private String name;

	public GetUnitsByGroupNameReturnTypeJsonSerializer() {
		this("GetUnitsByGroupNameReturnType");
	}

	public GetUnitsByGroupNameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
