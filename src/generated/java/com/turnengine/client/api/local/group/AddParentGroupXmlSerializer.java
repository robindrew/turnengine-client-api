...
public class AddParentGroupXmlSerializer implements IXmlSerializer<IAddParentGroup> {

	private String name;

	public AddParentGroupXmlSerializer() {
		this("AddParentGroup");
	}

	public AddParentGroupXmlSerializer(String name) {
		this.name = name;
	}
	...
	@Override
	public IAddParentGroup readObject(IXmlReader reader) {
	...
	@Override
	public void writeObject(IXmlWriter writer, IAddParentGroup object) {
