...
public class GetTurnIntervalReturnTypeXmlSerializer implements IXmlSerializer<Long> {

	private String name;

	public GetTurnIntervalReturnTypeXmlSerializer() {
		this("GetTurnIntervalReturnType");
	}

	public GetTurnIntervalReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
