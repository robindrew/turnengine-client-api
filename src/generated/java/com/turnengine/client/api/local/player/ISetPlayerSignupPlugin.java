...
public interface ISetPlayerSignupPlugin extends IExecutableBean<Boolean>, ILocalLoggedInBean<Boolean>, ISetupBean<Boolean>, Comparable<ISetPlayerSignupPlugin> {

	int SERIALIZATION_ID = 6015;
