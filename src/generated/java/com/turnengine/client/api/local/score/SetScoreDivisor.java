...
public class SetScoreDivisor implements ISetScoreDivisor {
	 ...
	 */
	public SetScoreDivisor() {
	}

	/**
	 * The fields constructor.
	 */
	public SetScoreDivisor(long loginId, int instanceId, String group, long divisor) {
		setLoginId(loginId);
	 ...
	 */
	public SetScoreDivisor(ISetScoreDivisor clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ISetScoreDivisor that = (ISetScoreDivisor) object;
	...
	@Override
	public int compareTo(ISetScoreDivisor that) {
