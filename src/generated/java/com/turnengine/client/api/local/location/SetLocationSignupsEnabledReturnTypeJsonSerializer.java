...
public class SetLocationSignupsEnabledReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetLocationSignupsEnabledReturnTypeJsonSerializer() {
		this("SetLocationSignupsEnabledReturnType");
	}

	public SetLocationSignupsEnabledReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
