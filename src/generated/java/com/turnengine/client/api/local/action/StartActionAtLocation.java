...
public class StartActionAtLocation implements IStartActionAtLocation {
	 ...
	 */
	public StartActionAtLocation() {
	}

	/**
	 * The fields constructor.
	 */
	public StartActionAtLocation(long loginId, int instanceId, int locationId, int actionId, long amount, boolean addToQueue) {
		setLoginId(loginId);
	 ...
	 */
	public StartActionAtLocation(IStartActionAtLocation clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IStartActionAtLocation that = (IStartActionAtLocation) object;
	...
	@Override
	public int compareTo(IStartActionAtLocation that) {
