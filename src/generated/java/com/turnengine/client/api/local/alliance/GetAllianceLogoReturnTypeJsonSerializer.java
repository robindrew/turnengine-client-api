...
public class GetAllianceLogoReturnTypeJsonSerializer implements IJsonSerializer<IImage> {

	private String name;

	public GetAllianceLogoReturnTypeJsonSerializer() {
		this("GetAllianceLogoReturnType");
	}

	public GetAllianceLogoReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
