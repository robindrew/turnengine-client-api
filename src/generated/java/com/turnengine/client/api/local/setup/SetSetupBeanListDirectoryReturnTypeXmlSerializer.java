...
public class SetSetupBeanListDirectoryReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public SetSetupBeanListDirectoryReturnTypeXmlSerializer() {
		this("SetSetupBeanListDirectoryReturnType");
	}

	public SetSetupBeanListDirectoryReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
