...
public class GetLocationsEnabledReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public GetLocationsEnabledReturnTypeJsonSerializer() {
		this("GetLocationsEnabledReturnType");
	}

	public GetLocationsEnabledReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
