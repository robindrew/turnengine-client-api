...
public class RenameMobile implements IRenameMobile {
	 ...
	 */
	public RenameMobile(long loginId, int instanceId, int mobileId, String name) {
		setLoginId(loginId);
	 ...
	 */
	public RenameMobile(IRenameMobile clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		IRenameMobile that = (IRenameMobile) object;
	...
	@Override
	public int compareTo(IRenameMobile that) {
