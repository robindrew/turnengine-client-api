...
public class ListActionsQueuedAtMobileReturnTypeJsonSerializer implements IJsonSerializer<List<IActionQueued>> {

	private String name;

	public ListActionsQueuedAtMobileReturnTypeJsonSerializer() {
		this("ListActionsQueuedAtMobileReturnType");
	}

	public ListActionsQueuedAtMobileReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
