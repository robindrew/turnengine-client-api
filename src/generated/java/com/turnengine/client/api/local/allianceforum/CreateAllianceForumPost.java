...
public class CreateAllianceForumPost implements ICreateAllianceForumPost {
	 ...
	 */
	public CreateAllianceForumPost() {
	}

	/**
	 * The fields constructor.
	 */
	public CreateAllianceForumPost(long loginId, int instanceId, int threadId, String subject, String content) {
		setLoginId(loginId);
	 ...
	 */
	public CreateAllianceForumPost(ICreateAllianceForumPost clone) {
	...
	public boolean equals(Object object) {
		...
		// Compare fields
		ICreateAllianceForumPost that = (ICreateAllianceForumPost) object;
	...
	@Override
	public int compareTo(ICreateAllianceForumPost that) {
