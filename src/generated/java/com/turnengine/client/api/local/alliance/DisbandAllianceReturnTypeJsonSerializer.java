...
public class DisbandAllianceReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public DisbandAllianceReturnTypeJsonSerializer() {
		this("DisbandAllianceReturnType");
	}

	public DisbandAllianceReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
