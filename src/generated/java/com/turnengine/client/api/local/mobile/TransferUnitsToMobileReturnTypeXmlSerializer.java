...
public class TransferUnitsToMobileReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public TransferUnitsToMobileReturnTypeXmlSerializer() {
		this("TransferUnitsToMobileReturnType");
	}

	public TransferUnitsToMobileReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
