...
public class SetGameInstanceReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetGameInstanceReturnTypeJsonSerializer() {
		this("SetGameInstanceReturnType");
	}

	public SetGameInstanceReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
