...
public class InviteToJoinAllianceByNameReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public InviteToJoinAllianceByNameReturnTypeJsonSerializer() {
		this("InviteToJoinAllianceByNameReturnType");
	}

	public InviteToJoinAllianceByNameReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
