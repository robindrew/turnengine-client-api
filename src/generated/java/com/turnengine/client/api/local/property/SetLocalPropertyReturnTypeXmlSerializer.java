...
public class SetLocalPropertyReturnTypeXmlSerializer implements IXmlSerializer<String> {

	private String name;

	public SetLocalPropertyReturnTypeXmlSerializer() {
		this("SetLocalPropertyReturnType");
	}

	public SetLocalPropertyReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
