...
public class GetUpkeepAtLocationReturnTypeJsonSerializer implements IJsonSerializer<List<IUnitCount>> {

	private String name;

	public GetUpkeepAtLocationReturnTypeJsonSerializer() {
		this("GetUpkeepAtLocationReturnType");
	}

	public GetUpkeepAtLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
