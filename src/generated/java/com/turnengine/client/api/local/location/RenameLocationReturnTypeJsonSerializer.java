...
public class RenameLocationReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public RenameLocationReturnTypeJsonSerializer() {
		this("RenameLocationReturnType");
	}

	public RenameLocationReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
