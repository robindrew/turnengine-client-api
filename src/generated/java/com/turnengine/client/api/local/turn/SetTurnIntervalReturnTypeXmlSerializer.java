...
public class SetTurnIntervalReturnTypeXmlSerializer implements IXmlSerializer<Long> {

	private String name;

	public SetTurnIntervalReturnTypeXmlSerializer() {
		this("SetTurnIntervalReturnType");
	}

	public SetTurnIntervalReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
