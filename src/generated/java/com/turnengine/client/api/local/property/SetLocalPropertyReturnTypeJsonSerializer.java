...
public class SetLocalPropertyReturnTypeJsonSerializer implements IJsonSerializer<String> {

	private String name;

	public SetLocalPropertyReturnTypeJsonSerializer() {
		this("SetLocalPropertyReturnType");
	}

	public SetLocalPropertyReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
