...
public class IsPlayerSignedUpReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public IsPlayerSignedUpReturnTypeXmlSerializer() {
		this("IsPlayerSignedUpReturnType");
	}

	public IsPlayerSignedUpReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
