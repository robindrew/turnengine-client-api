...
public class GetAllianceInviteLimitReturnTypeXmlSerializer implements IXmlSerializer<Integer> {

	private String name;

	public GetAllianceInviteLimitReturnTypeXmlSerializer() {
		this("GetAllianceInviteLimitReturnType");
	}

	public GetAllianceInviteLimitReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
