...
public class ShutdownGameReturnTypeXmlSerializer implements IXmlSerializer<Boolean> {

	private String name;

	public ShutdownGameReturnTypeXmlSerializer() {
		this("ShutdownGameReturnType");
	}

	public ShutdownGameReturnTypeXmlSerializer(String name) {
		this.name = name;
	}
