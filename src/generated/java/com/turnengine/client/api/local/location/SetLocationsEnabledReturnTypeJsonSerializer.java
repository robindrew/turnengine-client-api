...
public class SetLocationsEnabledReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public SetLocationsEnabledReturnTypeJsonSerializer() {
		this("SetLocationsEnabledReturnType");
	}

	public SetLocationsEnabledReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
