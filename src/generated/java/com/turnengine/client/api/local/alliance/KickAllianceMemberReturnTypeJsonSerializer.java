...
public class KickAllianceMemberReturnTypeJsonSerializer implements IJsonSerializer<Boolean> {

	private String name;

	public KickAllianceMemberReturnTypeJsonSerializer() {
		this("KickAllianceMemberReturnType");
	}

	public KickAllianceMemberReturnTypeJsonSerializer(String name) {
		this.name = name;
	}
